...
#[allow(dead_code)]
pub struct PostgresArAgingRepository {
    #[allow(dead_code)]
    pool: PgPool,
}
impl PostgresArAgingRepository {
    #[must_use]
...
impl ArAgingRepository for PostgresArAgingRepository {
    ...
    async fn get_definition(&self, _: Uuid, _: &str) -> AtlasResult<Option<ArAgingDefinition>> {
        Ok(None)
    }
    async fn get_definition_by_id(&self, _: Uuid) -> AtlasResult<Option<ArAgingDefinition>> {
        Ok(None)
    }
    async fn list_definitions(
        &self,
    ...
    async fn update_definition_status(&self, _: Uuid, _: &str) -> AtlasResult<ArAgingDefinition> {
    ...
    async fn list_buckets(&self, _: Uuid) -> AtlasResult<Vec<ArAgingBucket>> {
        Ok(vec![])
    }
    async fn create_snapshot(
        &self,
    ...
    async fn get_snapshot(&self, _: Uuid) -> AtlasResult<Option<ArAgingSnapshot>> {
        Ok(None)
    }
    async fn list_snapshots(&self, _: Uuid, _: Option<Uuid>) -> AtlasResult<Vec<ArAgingSnapshot>> {
        Ok(vec![])
    }
    ...
    async fn list_snapshot_lines(&self, _: Uuid) -> AtlasResult<Vec<ArAgingSnapshotLine>> {
        Ok(vec![])
    }
    async fn get_aging_summary(&self, _: Uuid) -> AtlasResult<Vec<ArAgingSummary>> {
        Ok(vec![])
    }
    async fn get_dashboard(&self, _: Uuid) -> AtlasResult<ArAgingDashboard> {
        Ok(ArAgingDashboard {
            total_definitions: 0,
            total_snapshots: 0,
