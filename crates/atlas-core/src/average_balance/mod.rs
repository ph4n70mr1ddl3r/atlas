...
#[allow(dead_code)]
pub struct PostgresAverageBalanceRepository {
    #[allow(dead_code)]
    pool: PgPool,
}
impl PostgresAverageBalanceRepository {
    #[must_use]
...
impl AverageBalanceRepository for PostgresAverageBalanceRepository {
    ...
    async fn get_book(&self, _: Uuid) -> AtlasResult<Option<AverageBalanceBook>> {
        Ok(None)
    }
    async fn get_book_by_code(&self, _: Uuid, _: &str) -> AtlasResult<Option<AverageBalanceBook>> {
        Ok(None)
    }
    async fn list_books(&self, _: Uuid, _: Option<&str>) -> AtlasResult<Vec<AverageBalanceBook>> {
        Ok(vec![])
    }
    async fn update_book_status(&self, _: Uuid, _: &str) -> AtlasResult<AverageBalanceBook> {
        Err(AtlasError::EntityNotFound("Mock".into()))
    }
    async fn delete_book(&self, _: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn list_accounts(&self, _: Uuid) -> AtlasResult<Vec<BookAccount>> {
        Ok(vec![])
    }
    async fn get_account(&self, _: Uuid) -> AtlasResult<Option<BookAccount>> {
        Ok(None)
    }
    async fn remove_account(&self, _: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn save_calculation(
        &self,
        _: AverageBalanceCalculation,
    ) -> AtlasResult<AverageBalanceCalculation> {
        Err(AtlasError::DatabaseError("Not implemented".into()))
    }
    async fn get_calculation(&self, _: Uuid) -> AtlasResult<Option<AverageBalanceCalculation>> {
        Ok(None)
    }
    async fn list_calculations(
        &self,
