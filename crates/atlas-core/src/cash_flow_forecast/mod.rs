...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CashForecastDashboard {
...
#[allow(dead_code)]
pub struct PostgresCashFlowForecastRepository {
    #[allow(dead_code)]
    pool: PgPool,
}
impl PostgresCashFlowForecastRepository {
    #[must_use]
...
impl CashFlowForecastRepository for PostgresCashFlowForecastRepository {
    ...
    async fn get_forecast(&self, _: Uuid, _: &str) -> AtlasResult<Option<CashForecast>> {
        Ok(None)
    }
