...
#[allow(dead_code)]
pub struct PostgresCashReceiptRepository {
    #[allow(dead_code)]
    pool: PgPool,
}
impl PostgresCashReceiptRepository {
    #[must_use]
...
impl CashReceiptRepository for PostgresCashReceiptRepository {
    ...
    async fn get_batch(&self, _: Uuid) -> AtlasResult<Option<ReceiptBatch>> {
        Ok(None)
    }
    async fn get_batch_by_number(&self, _: Uuid, _: &str) -> AtlasResult<Option<ReceiptBatch>> {
        Ok(None)
    }
    async fn list_batches(&self, _: Uuid, _: Option<&str>) -> AtlasResult<Vec<ReceiptBatch>> {
        Ok(vec![])
    }
    async fn update_batch_status(&self, _: Uuid, _: &str) -> AtlasResult<ReceiptBatch> {
        Err(AtlasError::EntityNotFound("Mock".into()))
    }
    async fn update_batch_totals(&self, _: Uuid, _: &str, _: i32) -> AtlasResult<()> {
        Ok(())
    }
    async fn delete_batch(&self, _: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_receipt(&self, _: Uuid) -> AtlasResult<Option<CashReceipt>> {
        Ok(None)
    }
    async fn get_receipt_by_number(&self, _: Uuid, _: &str) -> AtlasResult<Option<CashReceipt>> {
        Ok(None)
    }
    async fn list_receipts(
        &self,
    ...
    async fn update_receipt_status(&self, _: Uuid, _: &str) -> AtlasResult<CashReceipt> {
        Err(AtlasError::EntityNotFound("Mock".into()))
    }
    async fn update_receipt_amounts(&self, _: Uuid, _: &str, _: &str) -> AtlasResult<CashReceipt> {
        Err(AtlasError::EntityNotFound("Mock".into()))
    }
    async fn update_receipt_reversal(
        &self,
    ...
    async fn get_application(&self, _: Uuid) -> AtlasResult<Option<ReceiptApplication>> {
        Ok(None)
    }
    async fn list_applications(
        &self,
    ...
    async fn sum_applied_for_receipt(&self, _: Uuid) -> AtlasResult<String> {
        Ok("0.00".into())
    }
