...
use super::{ConfigChange, ConfigValue, ConfigWatcher, ConfigWatcherRegistry};
use std::collections::HashMap;
use std::sync::Arc;
use tokio::sync::RwLock;

/// Global config registry
pub static CONFIG_REGISTRY: std::sync::LazyLock<Arc<ConfigEngine>> =
    std::sync::LazyLock::new(|| Arc::new(ConfigEngine::new()));
