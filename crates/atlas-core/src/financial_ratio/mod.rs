...
pub trait FinancialRatioRepository: Send + Sync {
    ...
    async fn create_ratio_result(
        ...
        change_amount: Option<&str>,
        change_percent: Option<&str>,
...
#[allow(dead_code)]
pub struct PostgresFinancialRatioRepository {
    #[allow(dead_code)]
    pool: PgPool,
}
impl PostgresFinancialRatioRepository {
    #[must_use]
...
impl FinancialRatioRepository for PostgresFinancialRatioRepository {
    ...
    async fn get_definition(&self, _: Uuid, _: &str) -> AtlasResult<Option<RatioDefinition>> {
        Ok(None)
    }
    async fn get_definition_by_id(&self, _: Uuid) -> AtlasResult<Option<RatioDefinition>> {
        Ok(None)
    }
    async fn list_definitions(
        &self,
    ...
    async fn get_snapshot(&self, _: Uuid) -> AtlasResult<Option<RatioSnapshot>> {
        Ok(None)
    }
    async fn list_snapshots(&self, _: Uuid, _: Option<&str>) -> AtlasResult<Vec<RatioSnapshot>> {
        Ok(vec![])
    }
    async fn update_snapshot_status(&self, _: Uuid, _: &str, _: i32) -> AtlasResult<RatioSnapshot> {
    ...
    async fn list_ratio_results(&self, _: Uuid) -> AtlasResult<Vec<RatioResult>> {
        Ok(vec![])
    }
    async fn list_ratio_results_by_category(
        &self,
    ...
    async fn list_benchmarks(&self, _: Uuid, _: Option<Uuid>) -> AtlasResult<Vec<RatioBenchmark>> {
        Ok(vec![])
    }
