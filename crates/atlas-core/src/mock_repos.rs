...
use atlas_shared::{AuditEntry, EntityDefinition};
use uuid::Uuid;
...
impl AuditRepository for MockAuditRepository {
    async fn insert(&self, _entry: &AuditEntry) -> AtlasResult<()> {
        Ok(())
    }
    async fn query(&self, _query: &crate::audit::AuditQuery) -> AtlasResult<Vec<AuditEntry>> {
        Ok(vec![])
    }
    async fn get_by_id(&self, _id: Uuid) -> AtlasResult<Option<AuditEntry>> {
        Ok(None)
    }
    async fn get_by_ids(&self, _ids: &[Uuid]) -> AtlasResult<Vec<AuditEntry>> {
        Ok(vec![])
    }
}
...
impl IntercompanyRepository for MockIntercompanyRepository {
    async fn create_batch(
        ...
        _from_entity_id: Uuid,
        _from_entity_name: &str,
        _to_entity_id: Uuid,
        _to_entity_name: &str,
        _currency_code: &str,
        _accounting_date: Option<chrono::NaiveDate>,
        _created_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::IntercompanyBatch> {
        Ok(atlas_shared::IntercompanyBatch {
            id: Uuid::new_v4(),
            organization_id: _org_id,
            batch_number: _batch_number.to_string(),
            description: None,
            status: "draft".to_string(),
            from_entity_id: _from_entity_id,
            from_entity_name: _from_entity_name.to_string(),
            to_entity_id: _to_entity_id,
            to_entity_name: _to_entity_name.to_string(),
            currency_code: _currency_code.to_string(),
            total_amount: "0".to_string(),
            total_debit: "0".to_string(),
            total_credit: "0".to_string(),
            transaction_count: 0,
            from_journal_id: None,
            to_journal_id: None,
    ...
    async fn get_batch(
        ...
        _org_id: Uuid,
        _batch_number: &str,
    ) -> AtlasResult<Option<atlas_shared::IntercompanyBatch>> {
        Ok(None)
    }
    ...
    async fn list_batches(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::IntercompanyBatch>> {
        Ok(vec![])
    }
    async fn update_batch_status(
        ...
        _posted_at: Option<chrono::DateTime<chrono::Utc>>,
    ...
    async fn create_transaction(
        ...
        _amount: &str,
        _currency_code: &str,
        _exchange_rate: Option<&str>,
        _from_debit_account: Option<&str>,
        _from_credit_account: Option<&str>,
        _to_debit_account: Option<&str>,
        _to_credit_account: Option<&str>,
        _from_ic_account: &str,
        _to_ic_account: &str,
        _transaction_date: chrono::NaiveDate,
        _due_date: Option<chrono::NaiveDate>,
        _source_entity_type: Option<&str>,
        ...
        Ok(atlas_shared::IntercompanyTransaction {
            ...
            transaction_type: _transaction_type.to_string(),
            description: None,
            from_entity_id: _from_entity_id,
            from_entity_name: _from_entity_name.to_string(),
            to_entity_id: _to_entity_id,
            ...
            currency_code: _currency_code.to_string(),
            exchange_rate: None,
            from_debit_account: None,
            from_credit_account: None,
            to_debit_account: None,
            to_credit_account: None,
    ...
    async fn get_transaction(
        ...
        _org_id: Uuid,
        _transaction_number: &str,
    ) -> AtlasResult<Option<atlas_shared::IntercompanyTransaction>> {
        Ok(None)
    }
    async fn list_transactions_by_batch(
        &self,
        _batch_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::IntercompanyTransaction>> {
        Ok(vec![])
    }
    ...
    async fn update_transaction_status(
        ...
        _id: Uuid,
        _status: &str,
        _settlement_date: Option<chrono::NaiveDate>,
    ) -> AtlasResult<atlas_shared::IntercompanyTransaction> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn create_settlement(
        &self,
        _org_id: Uuid,
        _settlement_number: &str,
        _settlement_method: &str,
        _from_entity_id: Uuid,
        _to_entity_id: Uuid,
        _settled_amount: &str,
        _currency_code: &str,
        _payment_reference: Option<&str>,
        _transaction_ids: serde_json::Value,
        _created_by: Option<Uuid>,
    ...
    ) -> AtlasResult<Vec<atlas_shared::IntercompanySettlement>> {
        Ok(vec![])
    }
    async fn get_balance(
        ...
        _to_entity_id: Uuid,
        _currency_code: &str,
    ) -> AtlasResult<Option<atlas_shared::IntercompanyBalance>> {
        Ok(None)
    }
    async fn upsert_balance(
        ...
        _to_entity_id: Uuid,
        _currency_code: &str,
        _total_outstanding: &str,
        _total_posted: &str,
        _total_settled: &str,
        _open_transaction_count: i32,
    ...
    async fn list_balances(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::IntercompanyBalance>> {
        Ok(vec![])
    }
}
...
impl TaxRepository for MockTaxRepository {
    async fn create_regime(
        ...
        _description: Option<&str>,
        _tax_type: &str,
        _default_inclusive: bool,
        _allows_recovery: bool,
        _rounding_rule: &str,
        _rounding_precision: i32,
        ...
        Ok(atlas_shared::TaxRegime {
            ...
            description: None,
            tax_type: _tax_type.to_string(),
            default_inclusive: _default_inclusive,
            allows_recovery: _allows_recovery,
            rounding_rule: _rounding_rule.to_string(),
            rounding_precision: _rounding_precision,
            is_active: true,
            effective_from: None,
            effective_to: None,
            created_by: None,
    ...
    async fn get_regime(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::TaxRegime>> {
        Ok(None)
    }
    async fn get_regime_by_id(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::TaxRegime>> {
        Ok(None)
    }
    async fn list_regimes(&self, _org_id: Uuid) -> AtlasResult<Vec<atlas_shared::TaxRegime>> {
        Ok(vec![])
    }
    async fn delete_regime(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_jurisdiction(
        ...
        _code: &str,
        _name: &str,
        _geographic_level: &str,
        _country_code: Option<&str>,
        _state_code: Option<&str>,
        _county: Option<&str>,
        _city: Option<&str>,
        _postal_code_pattern: Option<&str>,
        _created_by: Option<Uuid>,
    ...
    async fn get_jurisdiction(
        ...
        _regime_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::TaxJurisdiction>> {
        Ok(None)
    }
    async fn list_jurisdictions(
        &self,
        _org_id: Uuid,
        _regime_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::TaxJurisdiction>> {
        Ok(vec![])
    }
    ...
    async fn create_tax_rate(
        ...
        _org_id: Uuid,
        _regime_id: Uuid,
        _jurisdiction_id: Option<&Uuid>,
        _code: &str,
        _name: &str,
        _rate_percentage: &str,
        _rate_type: &str,
        _tax_account_code: Option<&str>,
        _recoverable: bool,
        _recovery_percentage: Option<&str>,
        ...
        Ok(atlas_shared::TaxRate {
            ...
            code: _code.to_string(),
            name: _name.to_string(),
            rate_percentage: _rate_percentage.to_string(),
            rate_type: _rate_type.to_string(),
    ...
    async fn get_tax_rate(
        ...
        _regime_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::TaxRate>> {
        Ok(None)
    }
    async fn get_tax_rate_by_id(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::TaxRate>> {
        Ok(None)
    }
    async fn get_tax_rate_by_code(
        &self,
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::TaxRate>> {
    ...
    ) -> AtlasResult<Vec<atlas_shared::TaxRate>> {
        Ok(vec![])
    }
    ...
    async fn create_determination_rule(
        ...
        _effective_to: Option<chrono::NaiveDate>,
        _created_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::TaxDeterminationRule> {
        Ok(atlas_shared::TaxDeterminationRule {
            id: Uuid::new_v4(),
            organization_id: _org_id,
            regime_id: _regime_id,
            name: _name.to_string(),
    ...
    async fn list_determination_rules(
        ...
        _org_id: Uuid,
        _regime_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::TaxDeterminationRule>> {
        Ok(vec![])
    }
    async fn create_tax_line(
        ...
        _entity_type: &str,
        _entity_id: Uuid,
        _line_id: Option<Uuid>,
        _regime_id: Option<Uuid>,
        _jurisdiction_id: Option<Uuid>,
        _tax_rate_id: Uuid,
        _taxable_amount: &str,
        _tax_rate_percentage: &str,
        _tax_amount: &str,
        _is_inclusive: bool,
        _original_amount: Option<&str>,
        _recoverable_amount: Option<&str>,
        _non_recoverable_amount: Option<&str>,
        _tax_account_code: Option<&str>,
        _determination_rule_id: Option<Uuid>,
        _created_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::TaxLine> {
        Ok(atlas_shared::TaxLine {
            id: Uuid::new_v4(),
            organization_id: _org_id,
            ...
            non_recoverable_amount: None,
            tax_account_code: None,
            determination_rule_id: None,
            created_by: None,
            created_at: chrono::Utc::now(),
        })
    }
    async fn get_tax_lines(
        &self,
        _entity_type: &str,
        _entity_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::TaxLine>> {
        Ok(vec![])
    }
    async fn generate_tax_report(
        ...
        Ok(atlas_shared::TaxReport {
            ...
            total_taxable_amount: "0".to_string(),
            total_tax_amount: "0".to_string(),
            total_recoverable_amount: "0".to_string(),
            total_non_recoverable_amount: "0".to_string(),
            transaction_count: 0,
            status: "draft".to_string(),
            filed_by: None,
            filed_at: None,
...
impl ReconciliationRepository for MockReconciliationRepository {
    async fn create_bank_account(
        ...
        Ok(atlas_shared::BankAccount {
            ...
            bank_code: bank_code.map(String::from),
            branch_name: branch_name.map(String::from),
            branch_code: branch_code.map(String::from),
    ...
    async fn get_bank_account(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::BankAccount>> {
        Ok(None)
    }
    async fn list_bank_accounts(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::BankAccount>> {
        Ok(vec![])
    }
    async fn delete_bank_account(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_bank_statement(
        ...
        Ok(atlas_shared::BankStatement {
            ...
            total_deposits: serde_json::json!(0),
            total_withdrawals: serde_json::json!(0),
            total_interest: serde_json::json!(0),
            total_charges: serde_json::json!(0),
            total_lines: 0,
            matched_lines: 0,
            unmatched_lines: 0,
            status: "imported".to_string(),
            reconciliation_percent: serde_json::json!(0),
            imported_by,
            reviewed_by: None,
            reconciled_by: None,
            reconciled_at: None,
    ...
    async fn get_bank_statement(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::BankStatement>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::BankStatement>> {
        Ok(vec![])
    }
    ...
    async fn list_statement_lines(
        &self,
        _statement_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::BankStatementLine>> {
        Ok(vec![])
    }
    ...
    async fn get_system_transaction(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SystemTransaction>> {
        Ok(None)
    }
    async fn list_unreconciled_transactions(
        ...
        _org_id: Uuid,
        _bank_account_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SystemTransaction>> {
        Ok(vec![])
    }
    ...
    async fn create_match(
        ...
        Ok(atlas_shared::ReconciliationMatch {
            ...
            matched_by,
            matched_at: Some(chrono::Utc::now()),
            unmatched_by: None,
            unmatched_at: None,
    ...
    async fn get_match(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ReconciliationMatch>> {
        Ok(None)
    }
    async fn list_matches(
        &self,
        _statement_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ReconciliationMatch>> {
        Ok(vec![])
    }
    async fn unmatch(
        &self,
        _id: Uuid,
        _unmatched_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::ReconciliationMatch> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn get_or_create_summary(
        ...
        Ok(atlas_shared::ReconciliationSummary {
            ...
            period_end,
            statement_id: None,
            statement_balance: serde_json::json!(0),
            book_balance: serde_json::json!(0),
            deposits_in_transit: serde_json::json!(0),
            outstanding_checks: serde_json::json!(0),
            bank_charges: serde_json::json!(0),
            bank_interest: serde_json::json!(0),
            errors_and_omissions: serde_json::json!(0),
            adjusted_book_balance: serde_json::json!(0),
            adjusted_bank_balance: serde_json::json!(0),
            difference: serde_json::json!(0),
            is_balanced: false,
    ...
    async fn list_summaries(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ReconciliationSummary>> {
        Ok(vec![])
    }
    ...
    async fn list_matching_rules(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ReconciliationMatchingRule>> {
        Ok(vec![])
    }
    async fn delete_matching_rule(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
}
...
impl ExpenseRepository for MockExpenseRepository {
    async fn create_category(
        ...
        Ok(atlas_shared::ExpenseCategory {
            ...
            description: description.map(String::from),
            receipt_required,
            receipt_threshold: receipt_threshold.map(String::from),
            is_per_diem,
            default_per_diem_rate: default_per_diem_rate.map(String::from),
            is_mileage,
            default_mileage_rate: default_mileage_rate.map(String::from),
    ...
    async fn get_category(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::ExpenseCategory>> {
        Ok(None)
    }
    ...
    async fn list_categories(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ExpenseCategory>> {
        Ok(vec![])
    }
    async fn delete_category(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_policy(
        ...
        Ok(atlas_shared::ExpensePolicy {
            ...
            description: description.map(String::from),
            category_id,
            min_amount: min_amount.map(String::from),
            max_amount: max_amount.map(String::from),
            daily_limit: daily_limit.map(String::from),
            report_limit: report_limit.map(String::from),
            requires_approval_on_violation,
            violation_action: violation_action.to_string(),
            is_active: true,
            effective_from,
            effective_to,
            created_by,
    ...
    async fn get_policy(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ExpensePolicy>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::ExpensePolicy>> {
        Ok(vec![])
    }
    async fn delete_policy(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_report(
        ...
        Ok(atlas_shared::ExpenseReport {
            ...
            status: "draft".to_string(),
            employee_id,
            employee_name: employee_name.map(String::from),
            department_id,
            purpose: purpose.map(String::from),
            project_id,
            currency_code: currency_code.to_string(),
            total_amount: "0".to_string(),
            reimbursable_amount: "0".to_string(),
            receipt_required_amount: "0".to_string(),
            receipt_count: 0,
            trip_start_date,
            trip_end_date,
    ...
    async fn get_report(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ExpenseReport>> {
        Ok(None)
    }
    async fn get_report_by_number(
        ...
        _org_id: Uuid,
        _report_number: &str,
    ) -> AtlasResult<Option<atlas_shared::ExpenseReport>> {
        Ok(None)
    }
    async fn list_reports(
        ...
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::ExpenseReport>> {
        Ok(vec![])
    }
    async fn update_report_status(
        ...
        _reimbursed_at: Option<chrono::DateTime<chrono::Utc>>,
    ) -> AtlasResult<atlas_shared::ExpenseReport> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn create_line(
        ...
        Ok(atlas_shared::ExpenseLine {
            ...
            line_number,
            expense_category_id,
            expense_category_name: expense_category_name.map(String::from),
            ...
            is_reimbursable,
            has_receipt,
            receipt_reference: receipt_reference.map(String::from),
            merchant_name: merchant_name.map(String::from),
            location: location.map(String::from),
            attendees,
            per_diem_days,
            per_diem_rate: per_diem_rate.map(String::from),
            mileage_distance,
            mileage_rate: mileage_rate.map(String::from),
            mileage_unit: mileage_unit.map(String::from),
            mileage_from: mileage_from.map(String::from),
            mileage_to: mileage_to.map(String::from),
            policy_violation,
            policy_violation_message: policy_violation_message.map(String::from),
            expense_account_code: expense_account_code.map(String::from),
            metadata: serde_json::json!({}),
            created_by,
            created_at: chrono::Utc::now(),
    ...
    async fn get_line(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ExpenseLine>> {
        Ok(None)
    }
    async fn list_lines_by_report(
        &self,
        _report_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ExpenseLine>> {
        Ok(vec![])
    }
    async fn delete_line(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
}
...
impl BudgetRepository for MockBudgetRepository {
    ...
    async fn get_definition(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::BudgetDefinition>> {
        Ok(None)
    }
    async fn get_definition_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::BudgetDefinition>> {
        Ok(None)
    ...
    async fn list_definitions(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::BudgetDefinition>> {
        Ok(vec![])
    }
    async fn delete_definition(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_version(
        ...
        Ok(atlas_shared::BudgetVersion {
            ...
            status: "draft".to_string(),
            total_budget_amount: "0".to_string(),
            total_committed_amount: "0".to_string(),
            total_actual_amount: "0".to_string(),
            total_variance_amount: "0".to_string(),
            submitted_by: None,
            submitted_at: None,
            approved_by: None,
            approved_at: None,
    ...
    async fn get_version(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::BudgetVersion>> {
        Ok(None)
    }
    async fn get_active_version(
        &self,
        _definition_id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::BudgetVersion>> {
        Ok(None)
    }
    async fn list_versions(
        &self,
        _definition_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::BudgetVersion>> {
        Ok(vec![])
    }
    async fn get_next_version_number(&self, _definition_id: Uuid) -> AtlasResult<i32> {
        Ok(1)
    }
    ...
    async fn create_line(
        ...
        Ok(atlas_shared::BudgetLine {
            ...
            quarter,
            department_id,
            department_name: department_name.map(String::from),
            project_id,
            ...
            variance_amount: budget_amount.to_string(),
            variance_percent: "100".to_string(),
            carry_forward_amount: "0".to_string(),
            transferred_in_amount: "0".to_string(),
            transferred_out_amount: "0".to_string(),
            description: description.map(String::from),
            metadata: serde_json::json!({}),
            created_by,
            created_at: chrono::Utc::now(),
    ...
    async fn get_line(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::BudgetLine>> {
        Ok(None)
    }
    async fn list_lines_by_version(
        &self,
        _version_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::BudgetLine>> {
        Ok(vec![])
    }
    async fn find_line(
        &self,
        ...
        _cost_center: Option<&str>,
    ) -> AtlasResult<Option<atlas_shared::BudgetLine>> {
        Ok(None)
    }
    async fn update_line_amount(
        &self,
        _id: Uuid,
        _budget_amount: &str,
    ) -> AtlasResult<atlas_shared::BudgetLine> {
    ...
    async fn create_transfer(
        ...
        Ok(atlas_shared::BudgetTransfer {
            ...
            organization_id: org_id,
            version_id,
            transfer_number: transfer_number.to_string(),
            description: description.map(String::from),
            from_account_code: from_account_code.to_string(),
            from_period_name: from_period_name.map(String::from),
            from_department_id,
            from_cost_center: from_cost_center.map(String::from),
            to_account_code: to_account_code.to_string(),
            to_period_name: to_period_name.map(String::from),
            to_department_id,
            to_cost_center: to_cost_center.map(String::from),
            amount: amount.to_string(),
            status: "pending".to_string(),
            approved_by: None,
            approved_at: None,
    ...
    async fn get_transfer(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::BudgetTransfer>> {
        Ok(None)
    }
    async fn list_transfers(
        &self,
        _version_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::BudgetTransfer>> {
        Ok(vec![])
    }
...
impl FixedAssetRepository for MockFixedAssetRepository {
    ...
    async fn get_category(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::AssetCategory>> {
        Ok(None)
    }
    async fn get_category_by_id(
        &self,
    ...
    async fn list_categories(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::AssetCategory>> {
        Ok(vec![])
    }
    async fn delete_category(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    ...
    async fn create_book(
        ...
        Ok(atlas_shared::AssetBook {
            ...
            auto_depreciation,
            depreciation_calendar: depreciation_calendar.to_string(),
    ...
    async fn get_book(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::AssetBook>> {
        Ok(None)
    }
    async fn get_book_by_id(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::AssetBook>> {
        Ok(None)
    }
    async fn list_books(&self, _org_id: Uuid) -> AtlasResult<Vec<atlas_shared::AssetBook>> {
        Ok(vec![])
    }
    async fn delete_book(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_asset(
        ...
        Ok(atlas_shared::FixedAsset {
            ...
            description: description.map(String::from),
            category_id,
            category_code: category_code.map(String::from),
            book_id,
            book_code: book_code.map(String::from),
            asset_type: asset_type.to_string(),
            status: "draft".to_string(),
            original_cost: original_cost.to_string(),
            current_cost: original_cost.to_string(),
            salvage_value: salvage_value.to_string(),
            salvage_value_percent: salvage_value_percent.to_string(),
            depreciation_method: depreciation_method.to_string(),
            useful_life_months,
            declining_balance_rate: declining_balance_rate.map(String::from),
            depreciable_basis: "0".to_string(),
            accumulated_depreciation: "0".to_string(),
            net_book_value: original_cost.to_string(),
            depreciation_per_period: "0".to_string(),
            periods_depreciated: 0,
            last_depreciation_date: None,
            last_depreciation_amount: "0".to_string(),
            acquisition_date,
            ...
            department_name: department_name.map(String::from),
            custodian_id,
            custodian_name: custodian_name.map(String::from),
            serial_number: serial_number.map(String::from),
            tag_number: tag_number.map(String::from),
            manufacturer: manufacturer.map(String::from),
            model: model.map(String::from),
            warranty_expiry,
            insurance_policy_number: insurance_policy_number.map(String::from),
            insurance_expiry,
            lease_number: lease_number.map(String::from),
            lease_expiry,
    ...
    async fn get_asset(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::FixedAsset>> {
        Ok(None)
    }
    async fn get_asset_by_number(
        ...
        _org_id: Uuid,
        _asset_number: &str,
    ) -> AtlasResult<Option<atlas_shared::FixedAsset>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::FixedAsset>> {
        Ok(vec![])
    }
    async fn update_asset_status(
        ...
        _id: Uuid,
        _status: &str,
        _in_service_date: Option<chrono::NaiveDate>,
        _disposal_date: Option<chrono::NaiveDate>,
        _retirement_date: Option<chrono::NaiveDate>,
    ) -> AtlasResult<atlas_shared::FixedAsset> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn update_asset_depreciation(
        &self,
        _id: Uuid,
        _accumulated_depreciation: &str,
        _net_book_value: &str,
        _periods_depreciated: i32,
        _last_depreciation_date: Option<chrono::NaiveDate>,
        _last_depreciation_amount: &str,
    ) -> AtlasResult<atlas_shared::FixedAsset> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn update_asset_assignment(
        ...
        _id: Uuid,
        _department_id: Option<Uuid>,
        _department_name: Option<&str>,
        _location: Option<&str>,
        _custodian_id: Option<Uuid>,
        _custodian_name: Option<&str>,
    ) -> AtlasResult<atlas_shared::FixedAsset> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn delete_asset(&self, _org_id: Uuid, _asset_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn list_depreciation_history(
        &self,
        _asset_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::AssetDepreciationHistory>> {
        Ok(vec![])
    }
    async fn get_depreciation_for_period(
        ...
        _fiscal_year: i32,
        _period_number: i32,
    ) -> AtlasResult<Option<atlas_shared::AssetDepreciationHistory>> {
        Ok(None)
    }
    ...
    async fn create_transfer(
        ...
        Ok(atlas_shared::AssetTransfer {
            ...
            asset_id,
            from_department_id,
            from_department_name: from_department_name.map(String::from),
            from_location: from_location.map(String::from),
            from_custodian_id,
            from_custodian_name: from_custodian_name.map(String::from),
            to_department_id,
            to_department_name: to_department_name.map(String::from),
            to_location: to_location.map(String::from),
            to_custodian_id,
            to_custodian_name: to_custodian_name.map(String::from),
            transfer_date,
    ...
    async fn get_transfer(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::AssetTransfer>> {
        Ok(None)
    }
    async fn list_transfers(
        &self,
    ...
    ) -> AtlasResult<Vec<atlas_shared::AssetTransfer>> {
        Ok(vec![])
    }
    async fn update_transfer_status(
        &self,
    ...
    async fn create_retirement(
        ...
        Ok(atlas_shared::AssetRetirement {
            id: Uuid::new_v4(),
            organization_id: org_id,
            retirement_number: retirement_number.to_string(),
            asset_id,
            retirement_type: retirement_type.to_string(),
            retirement_date,
            proceeds: proceeds.to_string(),
            removal_cost: removal_cost.to_string(),
            net_book_value_at_retirement: net_book_value_at_retirement.to_string(),
            accumulated_depreciation_at_retirement: accumulated_depreciation_at_retirement
                .to_string(),
            gain_loss_amount: gain_loss_amount.to_string(),
            gain_loss_type: gain_loss_type.map(String::from),
            gain_account_code: gain_account_code.map(String::from),
            loss_account_code: loss_account_code.map(String::from),
    ...
    async fn get_retirement(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::AssetRetirement>> {
        Ok(None)
    }
    async fn list_retirements(
        ...
        _org_id: Uuid,
        _asset_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::AssetRetirement>> {
        Ok(vec![])
    }
...
impl crate::collections::CollectionsRepository for MockCollectionsRepository {
    ...
    async fn create_credit_profile(
        ...
        Ok(atlas_shared::CustomerCreditProfile {
            ...
            total_overdue_amount: "0".to_string(),
            oldest_overdue_date: None,
            credit_hold: false,
            credit_hold_reason: None,
            credit_hold_date: None,
            credit_hold_by: None,
    ...
    async fn get_credit_profile(
        ...
        _org_id: Uuid,
        _customer_id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::CustomerCreditProfile>> {
        Ok(None)
    }
    ...
    async fn list_credit_profiles(
        ...
        _status: Option<&str>,
        _risk: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::CustomerCreditProfile>> {
        Ok(vec![])
    }
    async fn update_credit_profile(
        &self,
        _id: Uuid,
        _credit_limit: Option<&str>,
        _credit_used: Option<&str>,
        _risk: Option<&str>,
        _score: Option<i32>,
        _terms: Option<&str>,
        _avg_days: Option<&str>,
        _overdue_count: Option<i32>,
        _overdue_amount: Option<&str>,
        _oldest: Option<chrono::NaiveDate>,
        _hold: Option<bool>,
        _hold_reason: Option<&str>,
        _hold_date: Option<chrono::DateTime<chrono::Utc>>,
        _hold_by: Option<Uuid>,
        _last_review: Option<chrono::NaiveDate>,
        _next_review: Option<chrono::NaiveDate>,
        _status: Option<&str>,
    ) -> AtlasResult<atlas_shared::CustomerCreditProfile> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn create_strategy(
        ...
        description: Option<&str>,
        strategy_type: &str,
        applicable_risk: serde_json::Value,
        trigger_buckets: serde_json::Value,
        threshold: &str,
        ...
        Ok(atlas_shared::CollectionStrategy {
            ...
            applicable_risk_classifications: applicable_risk,
            trigger_aging_buckets: trigger_buckets,
            overdue_amount_threshold: threshold.to_string(),
            actions,
            priority,
            is_active: true,
            metadata: serde_json::json!({}),
    ...
    async fn get_strategy(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::CollectionStrategy>> {
        Ok(None)
    }
    async fn list_strategies(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::CollectionStrategy>> {
        Ok(vec![])
    }
    async fn delete_strategy(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_case(
        ...
        total_invoiced: &str,
        overdue_count: i32,
        oldest_overdue: Option<chrono::NaiveDate>,
        ...
        Ok(atlas_shared::CollectionCase {
            ...
            strategy_id,
            assigned_to,
            assigned_to_name: assigned_to_name.map(String::from),
    ...
    async fn get_case(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::CollectionCase>> {
        Ok(None)
    }
    async fn get_case_by_number(
        ...
        _org_id: Uuid,
        _case_number: &str,
    ) -> AtlasResult<Option<atlas_shared::CollectionCase>> {
        Ok(None)
    }
    async fn list_cases(
        &self,
    ...
    ) -> AtlasResult<Vec<atlas_shared::CollectionCase>> {
        Ok(vec![])
    }
    async fn update_case_status(
        ...
        _status: &str,
        _step: Option<i32>,
        _assigned: Option<Uuid>,
        _assigned_name: Option<&str>,
        _last_action: Option<chrono::NaiveDate>,
        _next_action: Option<chrono::NaiveDate>,
        _resolution_type: Option<&str>,
        _resolution_notes: Option<&str>,
        _resolved: Option<chrono::NaiveDate>,
    ...
    async fn create_interaction(
        ...
        Ok(atlas_shared::CustomerInteraction {
            ...
            contact_role: contact_role.map(String::from),
            ...
            follow_up_date,
            follow_up_notes: follow_up_notes.map(String::from),
            performed_by,
            performed_by_name: performed_by_name.map(String::from),
            performed_at: Some(chrono::Utc::now()),
            duration_minutes,
            metadata: serde_json::json!({}),
            created_at: chrono::Utc::now(),
            updated_at: chrono::Utc::now(),
    ...
    async fn get_interaction(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::CustomerInteraction>> {
        Ok(None)
    }
    async fn list_interactions(
        &self,
        _org_id: Uuid,
        _case_id: Option<Uuid>,
        _customer_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::CustomerInteraction>> {
        Ok(vec![])
    }
    ...
    async fn create_promise_to_pay(
        ...
        Ok(atlas_shared::PromiseToPay {
            ...
            promised_amount: promised_amount.to_string(),
            paid_amount: "0".to_string(),
            remaining_amount: promised_amount.to_string(),
            promise_date,
            installment_count,
            installment_frequency: installment_frequency.map(String::from),
            status: "pending".to_string(),
            broken_date: None,
            broken_reason: None,
            related_invoice_ids: invoice_ids,
    ...
    async fn get_promise_to_pay(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::PromiseToPay>> {
        Ok(None)
    }
    async fn list_promises_to_pay(
        ...
        _customer_id: Option<Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::PromiseToPay>> {
        Ok(vec![])
    }
    async fn update_promise_status(
        ...
        _broken_date: Option<chrono::NaiveDate>,
        _broken_reason: Option<&str>,
    ) -> AtlasResult<atlas_shared::PromiseToPay> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn create_dunning_campaign(
        ...
        Ok(atlas_shared::DunningCampaign {
            id: Uuid::new_v4(),
            organization_id: org_id,
            campaign_number: campaign_number.to_string(),
            name: name.to_string(),
            description: description.map(String::from),
            dunning_level: dunning_level.to_string(),
            communication_method: comm_method.to_string(),
            template_id,
            template_name: template_name.map(String::from),
            min_overdue_days: min_days,
            min_overdue_amount: min_amount.to_string(),
            target_risk_classifications: target_risk,
            exclude_active_cases: exclude_active,
            scheduled_date,
            sent_date: None,
    ...
    async fn get_dunning_campaign(
        ...
        _org_id: Uuid,
        _num: &str,
    ) -> AtlasResult<Option<atlas_shared::DunningCampaign>> {
        Ok(None)
    }
    async fn list_dunning_campaigns(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::DunningCampaign>> {
        Ok(vec![])
    }
    ...
    async fn list_dunning_letters(
        ...
        _campaign_id: Option<Uuid>,
        _customer_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::DunningLetter>> {
        Ok(vec![])
    }
    ...
    async fn list_aging_snapshots(
        ...
        _org_id: Uuid,
        _date: chrono::NaiveDate,
    ) -> AtlasResult<Vec<atlas_shared::ReceivablesAgingSnapshot>> {
        Ok(vec![])
    }
    ...
    async fn create_write_off_request(
        ...
        Ok(atlas_shared::WriteOffRequest {
            ...
            customer_number: customer_number.map(String::from),
            customer_name: customer_name.map(String::from),
            write_off_type: write_off_type.to_string(),
            write_off_amount: write_off_amount.to_string(),
            write_off_account_code: account_code.map(String::from),
    ...
    async fn get_write_off_request(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::WriteOffRequest>> {
        Ok(None)
    }
    async fn list_write_off_requests(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::WriteOffRequest>> {
        Ok(vec![])
    }
...
impl RevenueRepository for MockRevenueRepository {
    ...
    async fn get_policy(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::RevenuePolicy>> {
        Ok(None)
    }
    ...
    async fn list_policies(&self, _org_id: Uuid) -> AtlasResult<Vec<atlas_shared::RevenuePolicy>> {
        Ok(vec![])
    }
    ...
    async fn create_contract(
        ...
        Ok(atlas_shared::RevenueContract {
            ...
            status: "draft".to_string(),
            step1_contract_identified: false,
            step2_obligations_identified: false,
            step3_price_determined: false,
            step4_price_allocated: false,
    ...
    async fn get_contract(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::RevenueContract>> {
        Ok(None)
    }
    async fn get_contract_by_number(
        ...
        _org_id: Uuid,
        _num: &str,
    ) -> AtlasResult<Option<atlas_shared::RevenueContract>> {
        Ok(None)
    }
    async fn list_contracts(
        ...
        _status: Option<&str>,
        _customer_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::RevenueContract>> {
        Ok(vec![])
    }
    async fn update_contract_status(
        ...
        _step4: Option<bool>,
        _step5: Option<bool>,
        _total_allocated: Option<&str>,
        _total_recognized: Option<&str>,
        _total_deferred: Option<&str>,
        _total_price: Option<&str>,
    ...
    async fn get_obligation(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::PerformanceObligation>> {
        Ok(None)
    }
    async fn list_obligations(
        &self,
        _contract_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PerformanceObligation>> {
        Ok(vec![])
    }
    ...
    async fn get_schedule_line(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::RevenueScheduleLine>> {
        Ok(None)
    }
    async fn list_schedule_lines(
        &self,
        _obligation_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::RevenueScheduleLine>> {
        Ok(vec![])
    }
    ...
    async fn update_schedule_line_status(
        ...
        _id: Uuid,
        _status: &str,
        _recognized: Option<&str>,
        _reversal: Option<&str>,
    ) -> AtlasResult<atlas_shared::RevenueScheduleLine> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn list_modifications(
        &self,
        _contract_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::RevenueModification>> {
        Ok(vec![])
    }
}
...
impl crate::payment::PaymentRepository for MockPaymentRepository {
    ...
    async fn create_payment_term(
        ...
        Ok(atlas_shared::PaymentTerm {
            ...
            due_days,
            discount_days,
            discount_percentage: discount_percentage.map(String::from),
            is_installment,
            installment_count,
            installment_frequency: installment_frequency.map(String::from),
    ...
    async fn get_payment_term(
        &self,
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::PaymentTerm>> {
        Ok(None)
    }
    async fn get_payment_term_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::PaymentTerm>> {
        Ok(None)
    ...
    async fn list_payment_terms(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PaymentTerm>> {
        Ok(vec![])
    }
    async fn delete_payment_term(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_payment_batch(
        ...
        Ok(atlas_shared::PaymentBatch {
            ...
            total_payment_amount: "0".to_string(),
            total_discount_taken: "0".to_string(),
            status: "draft".to_string(),
            selected_by: None,
            selected_at: None,
            approved_by: None,
            ...
            payment_file_name: None,
            payment_file_reference: None,
            metadata: serde_json::json!({}),
            created_by,
            created_at: chrono::Utc::now(),
            updated_at: chrono::Utc::now(),
    ...
    async fn get_payment_batch(
        ...
        _org_id: Uuid,
        _batch_number: &str,
    ) -> AtlasResult<Option<atlas_shared::PaymentBatch>> {
        Ok(None)
    }
    async fn get_payment_batch_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::PaymentBatch>> {
        Ok(None)
    ...
    async fn list_payment_batches(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::PaymentBatch>> {
        Ok(vec![])
    }
    async fn update_payment_batch_status(
        ...
        _id: Uuid,
        _status: &str,
        _action_by: Option<Uuid>,
        _cancellation_reason: Option<&str>,
    ) -> AtlasResult<atlas_shared::PaymentBatch> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn create_payment(
        ...
        Ok(atlas_shared::Payment {
            id: Uuid::new_v4(),
            organization_id: org_id,
            payment_number: payment_number.to_string(),
            batch_id,
            supplier_id,
            supplier_number: supplier_number.map(String::from),
            supplier_name: supplier_name.map(String::from),
            supplier_site: supplier_site.map(String::from),
            payment_date,
            payment_method: payment_method.to_string(),
            currency_code: currency_code.to_string(),
            payment_amount: payment_amount.to_string(),
            discount_taken: discount_taken.to_string(),
            bank_charges: "0".to_string(),
            bank_account_id,
            bank_account_name: bank_account_name.map(String::from),
            cash_account_code: cash_account_code.map(String::from),
            ...
            voided_at: None,
            void_reason: None,
            reissued_from_payment_id: None,
            reissued_payment_id: None,
            cleared_date: None,
            cleared_by: None,
            cleared_at: None,
            journal_entry_id: None,
    ...
    async fn get_payment(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::Payment>> {
        Ok(None)
    }
    async fn get_payment_by_number(
        ...
        _org_id: Uuid,
        _payment_number: &str,
    ) -> AtlasResult<Option<atlas_shared::Payment>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::Payment>> {
        Ok(vec![])
    }
    async fn update_payment_status(
        ...
        _id: Uuid,
        _status: &str,
        _cleared_date: Option<chrono::NaiveDate>,
        _cleared_by: Option<Uuid>,
        _void_reason: Option<&str>,
        _voided_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::Payment> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn list_payment_lines(
        &self,
        _payment_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PaymentLine>> {
        Ok(vec![])
    }
    ...
    async fn create_scheduled_payment(
        ...
        Ok(atlas_shared::ScheduledPayment {
            ...
            scheduled_amount: scheduled_amount.to_string(),
            installment_number,
    ...
    async fn list_scheduled_payments(
        ...
        _status: Option<&str>,
        _supplier_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::ScheduledPayment>> {
        Ok(vec![])
    }
    async fn update_scheduled_payment_status(
        ...
        _id: Uuid,
        _status: &str,
        _selected_batch_id: Option<Uuid>,
    ...
    async fn create_payment_format(
        ...
        Ok(atlas_shared::PaymentFormat {
            ...
            template_reference: template_reference.map(String::from),
            applicable_methods,
            is_system,
            is_active: true,
            metadata: serde_json::json!({}),
    ...
    async fn list_payment_formats(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PaymentFormat>> {
        Ok(vec![])
    }
    async fn delete_payment_format(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_remittance_advice(
        ...
        Ok(atlas_shared::RemittanceAdvice {
            ...
            delivery_address: delivery_address.map(String::from),
            contact_name: contact_name.map(String::from),
            contact_email: contact_email.map(String::from),
            subject: subject.map(String::from),
            body: body.map(String::from),
    ...
    async fn list_remittance_advices(
        ...
        _org_id: Uuid,
        _payment_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::RemittanceAdvice>> {
        Ok(vec![])
    }
...
impl crate::subledger_accounting::SubledgerAccountingRepository
    for MockSubledgerAccountingRepository
{
    // Accounting Methods
    async fn create_accounting_method(
        ...
        Ok(atlas_shared::AccountingMethod {
            ...
            require_balancing,
            intercompany_balancing_account: intercompany_balancing_account.map(String::from),
            effective_from,
            effective_to,
            is_active: true,
            metadata: serde_json::json!({}),
    ...
    async fn get_accounting_method(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::AccountingMethod>> {
        Ok(None)
    }
    async fn get_accounting_method_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::AccountingMethod>> {
        Ok(None)
    ...
    ) -> AtlasResult<Vec<atlas_shared::AccountingMethod>> {
        Ok(vec![])
    }
    async fn delete_accounting_method(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_derivation_rule(
        ...
        Ok(atlas_shared::AccountingDerivationRule {
            ...
            fixed_account_code: fixed_account_code.map(String::from),
            account_derivation_lookup,
            formula_expression: formula_expression.map(String::from),
            sequence,
            is_active: true,
            effective_from,
            effective_to,
    ...
    async fn get_derivation_rule(
        ...
        _method_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::AccountingDerivationRule>> {
        Ok(None)
    }
    async fn list_derivation_rules(
        ...
        _org_id: Uuid,
        _method_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::AccountingDerivationRule>> {
        Ok(vec![])
    }
    ...
    async fn create_journal_entry(
        ...
        Ok(atlas_shared::SubledgerJournalEntry {
            ...
            source_transaction_number: source_transaction_number.map(String::from),
            accounting_method_id,
            ...
            period_name: period_name.map(String::from),
            currency_code: currency_code.to_string(),
            entered_currency_code: entered_currency_code.to_string(),
            currency_conversion_date,
            currency_conversion_type: currency_conversion_type.map(String::from),
            ...
            entered_debit: entered_debit.to_string(),
            entered_credit: entered_credit.to_string(),
            status: status.to_string(),
            error_message: None,
            balancing_segment: balancing_segment.map(String::from),
            is_balanced,
            gl_transfer_status: "pending".to_string(),
            gl_transfer_date: None,
    ...
    async fn get_journal_entry(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SubledgerJournalEntry>> {
        Ok(None)
    }
    ...
    async fn list_journal_entries(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _source_application: Option<&str>,
        _source_transaction_type: Option<&str>,
        _accounting_date_from: Option<chrono::NaiveDate>,
        _accounting_date_to: Option<chrono::NaiveDate>,
    ) -> AtlasResult<Vec<atlas_shared::SubledgerJournalEntry>> {
        Ok(vec![])
    }
    async fn update_journal_entry_status(
        ...
        _is_balanced: Option<bool>,
        _posted_by: Option<Uuid>,
        _accounted_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::SubledgerJournalEntry> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn create_journal_line(
        ...
        Ok(atlas_shared::SubledgerJournalLine {
            ...
            derivation_rule_id,
            entered_amount: entered_amount.to_string(),
            accounted_amount: accounted_amount.to_string(),
            currency_code: currency_code.to_string(),
            conversion_date,
            conversion_rate: conversion_rate.map(String::from),
            attribute_category: attribute_category.map(String::from),
            attribute1: attribute1.map(String::from),
            attribute2: attribute2.map(String::from),
            attribute3: attribute3.map(String::from),
            attribute4: attribute4.map(String::from),
            attribute5: attribute5.map(String::from),
            attribute6: None,
            attribute7: None,
            attribute8: None,
            attribute9: None,
            ...
            source_line_id,
            source_line_type: source_line_type.map(String::from),
            is_reversal_line: false,
    ...
    ) -> AtlasResult<Vec<atlas_shared::SubledgerJournalLine>> {
        Ok(vec![])
    }
    async fn delete_journal_line(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::SlaEvent>> {
        Ok(vec![])
    }
    ...
    async fn create_transfer_log(
        ...
        Ok(atlas_shared::GlTransferLog {
            ...
            from_period: from_period.map(String::from),
            status: status.to_string(),
            error_message: None,
            total_entries,
            total_debit: total_debit.to_string(),
    ...
    async fn get_transfer_log(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::GlTransferLog>> {
        Ok(None)
    }
    async fn list_transfer_logs(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::GlTransferLog>> {
        Ok(vec![])
    }
...
impl crate::encumbrance::EncumbranceRepository for MockEncumbranceRepository {
    ...
    async fn get_encumbrance_type(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::EncumbranceType>> {
        Ok(None)
    }
    async fn get_encumbrance_type_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EncumbranceType>> {
        Ok(None)
    }
    async fn list_encumbrance_types(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::EncumbranceType>> {
        Ok(vec![])
    }
    async fn delete_encumbrance_type(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_entry(
        ...
        Ok(atlas_shared::EncumbranceEntry {
            ...
            entry_number: entry_number.to_string(),
            encumbrance_type_id,
            encumbrance_type_code: encumbrance_type_code.to_string(),
            source_type: source_type.map(String::from),
            source_id,
            source_number: source_number.map(String::from),
            description: description.map(String::from),
            ...
            current_amount: current_amount.to_string(),
    ...
    async fn get_entry(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::EncumbranceEntry>> {
        Ok(None)
    }
    async fn get_entry_by_number(
        ...
        _org_id: Uuid,
        _entry_number: &str,
    ) -> AtlasResult<Option<atlas_shared::EncumbranceEntry>> {
        Ok(None)
    }
    async fn list_entries(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _encumbrance_type_code: Option<&str>,
        _source_type: Option<&str>,
        _fiscal_year: Option<i32>,
    ) -> AtlasResult<Vec<atlas_shared::EncumbranceEntry>> {
        Ok(vec![])
    }
    ...
    async fn get_line(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::EncumbranceLine>> {
        Ok(None)
    }
    async fn list_lines_by_entry(
        &self,
        _entry_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::EncumbranceLine>> {
        Ok(vec![])
    }
    ...
    async fn create_liquidation(
        ...
        Ok(atlas_shared::EncumbranceLiquidation {
            id: Uuid::new_v4(),
            organization_id: org_id,
            liquidation_number: liquidation_number.to_string(),
    ...
    async fn get_liquidation(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EncumbranceLiquidation>> {
        Ok(None)
    }
    async fn list_liquidations(
        &self,
        _org_id: Uuid,
        _entry_id: Option<Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::EncumbranceLiquidation>> {
        Ok(vec![])
    }
    async fn update_liquidation_status(
        ...
        _id: Uuid,
        _status: &str,
        _reversed_by_id: Option<Uuid>,
        _reversal_reason: Option<&str>,
    ) -> AtlasResult<atlas_shared::EncumbranceLiquidation> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn get_carry_forward(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EncumbranceCarryForward>> {
        Ok(None)
    }
    async fn list_carry_forwards(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::EncumbranceCarryForward>> {
        Ok(vec![])
    }
...
impl crate::cash_management::CashManagementRepository for MockCashManagementRepository {
    ...
    async fn upsert_cash_position(
        ...
        Ok(atlas_shared::CashPosition {
            ...
            float_amount: float_amount.to_string(),
            one_day_float: one_day_float.to_string(),
            two_day_float: two_day_float.to_string(),
            position_date,
            average_balance: average_balance.map(String::from),
            prior_day_balance: prior_day_balance.map(String::from),
            projected_inflows: projected_inflows.to_string(),
            projected_outflows: projected_outflows.to_string(),
    ...
    async fn get_cash_position(
        ...
        _org_id: Uuid,
        _bank_account_id: Uuid,
        _position_date: chrono::NaiveDate,
    ) -> AtlasResult<Option<atlas_shared::CashPosition>> {
        Ok(None)
    }
    async fn get_cash_position_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::CashPosition>> {
        Ok(None)
    ...
    async fn list_cash_positions(
        &self,
        _org_id: Uuid,
        _position_date: Option<chrono::NaiveDate>,
    ) -> AtlasResult<Vec<atlas_shared::CashPosition>> {
        Ok(vec![])
    }
    ...
    async fn get_forecast_template(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::CashForecastTemplate>> {
        Ok(None)
    }
    ...
    async fn list_forecast_templates(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::CashForecastTemplate>> {
        Ok(vec![])
    }
    async fn delete_forecast_template(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_forecast_source(
        ...
        _template_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::CashForecastSource>> {
        Ok(None)
    }
    async fn list_forecast_sources(
        &self,
        _template_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::CashForecastSource>> {
        Ok(vec![])
    }
    ...
    async fn create_forecast(
        ...
        Ok(atlas_shared::CashForecast {
            id: Uuid::new_v4(),
            organization_id: org_id,
            forecast_number: forecast_number.to_string(),
            template_id,
            ...
            maximum_balance: maximum_balance.to_string(),
            deficit_count,
            surplus_count,
    ...
    async fn get_forecast(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::CashForecast>> {
        Ok(None)
    }
    async fn get_forecast_by_number(
        &self,
        _org_id: Uuid,
        _forecast_number: &str,
    ) -> AtlasResult<Option<atlas_shared::CashForecast>> {
        Ok(None)
    }
    async fn list_forecasts(
        ...
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::CashForecast>> {
        Ok(vec![])
    }
    ...
    async fn list_forecast_lines(
        &self,
        _forecast_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::CashForecastLine>> {
        Ok(vec![])
    }
...
impl crate::lease::LeaseAccountingRepository for MockLeaseAccountingRepository {
    async fn create_lease(
        ...
        Ok(atlas_shared::LeaseContract {
            id: Uuid::new_v4(),
            organization_id: org_id,
            lease_number: lease_number.to_string(),
            title: title.to_string(),
            description: description.map(String::from),
            classification: classification.to_string(),
            lessor_id,
            lessor_name: lessor_name.map(String::from),
    ...
    async fn get_lease(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::LeaseContract>> {
        Ok(None)
    }
    async fn get_lease_by_number(
        ...
        _org_id: Uuid,
        _lease_number: &str,
    ) -> AtlasResult<Option<atlas_shared::LeaseContract>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::LeaseContract>> {
        Ok(vec![])
    }
    async fn update_lease_status(
        ...
        _id: Uuid,
        _status: &str,
        _impairment_amount: Option<&str>,
        _impairment_date: Option<chrono::NaiveDate>,
    ) -> AtlasResult<atlas_shared::LeaseContract> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn update_lease_balances(
        &self,
        _id: Uuid,
        _current_liability: &str,
        _current_rou: &str,
        _accumulated_depreciation: &str,
        _total_payments_made: &str,
        _periods_elapsed: i32,
    ) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_payment(
        ...
        Ok(atlas_shared::LeasePayment {
            ...
            remaining_liability: remaining_liability.to_string(),
            rou_asset_value: rou_asset_value.to_string(),
            rou_depreciation: rou_depreciation.to_string(),
            accumulated_depreciation: accumulated_depreciation.to_string(),
            lease_expense: lease_expense.to_string(),
            is_paid,
    ...
    async fn get_payment_by_period(
        ...
        _lease_id: Uuid,
        _period_number: i32,
    ) -> AtlasResult<Option<atlas_shared::LeasePayment>> {
        Ok(None)
    }
    async fn list_payments(&self, _lease_id: Uuid) -> AtlasResult<Vec<atlas_shared::LeasePayment>> {
        Ok(vec![])
    }
    async fn update_payment_status(
        &self,
    ...
    async fn get_next_modification_number(&self, _lease_id: Uuid) -> AtlasResult<i32> {
        Ok(1)
    }
    async fn list_modifications(
        &self,
        _lease_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::LeaseModification>> {
        Ok(vec![])
    }
    ...
    async fn create_termination(
        ...
        Ok(atlas_shared::LeaseTermination {
            ...
            organization_id: org_id,
            lease_id,
            termination_type: termination_type.to_string(),
            termination_date,
            reason: reason.map(String::from),
            remaining_liability: remaining_liability.to_string(),
            remaining_rou_asset: remaining_rou_asset.to_string(),
    ...
    async fn list_terminations(
        &self,
        _lease_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::LeaseTermination>> {
        Ok(vec![])
    }
    ...
    async fn get_dashboard_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::LeaseDashboardSummary> {
        Ok(atlas_shared::LeaseDashboardSummary {
            total_active_leases: 0,
            total_lease_liability: "0".to_string(),
            total_rou_assets: "0".to_string(),
            total_rou_depreciation: "0".to_string(),
            total_net_rou_assets: "0".to_string(),
            total_payments_made: "0".to_string(),
            operating_lease_count: 0,
            finance_lease_count: 0,
...
impl ProjectCostingRepository for MockProjectCostingRepository {
    async fn create_cost_transaction(
        ...
        project_id: Uuid,
        _project_number: Option<&str>,
        task_id: Option<Uuid>,
        _task_number: Option<&str>,
        cost_type: &str,
        raw_cost_amount: &str,
    ...
    async fn get_cost_transaction(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::ProjectCostTransaction>> {
        Ok(None)
    }
    ...
    async fn list_cost_transactions(
        ...
        _cost_type: Option<&str>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::ProjectCostTransaction>> {
        Ok(vec![])
    }
    ...
    async fn get_burden_schedule(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::BurdenSchedule>> {
        Ok(None)
    }
    async fn get_burden_schedule_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::BurdenSchedule>> {
        Ok(None)
    }
    async fn list_burden_schedules(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::BurdenSchedule>> {
        Ok(vec![])
    }
    ...
    async fn list_burden_schedule_lines(
        &self,
        _schedule_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::BurdenScheduleLine>> {
        Ok(vec![])
    }
    async fn get_applicable_burden_rate(
        ...
        _schedule_id: Uuid,
        _cost_type: &str,
        _expenditure_category: Option<&str>,
    ) -> AtlasResult<Option<atlas_shared::BurdenScheduleLine>> {
        Ok(None)
    }
    ...
    async fn get_cost_adjustment(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::ProjectCostAdjustment>> {
        Ok(None)
    }
    async fn list_cost_adjustments(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::ProjectCostAdjustment>> {
        Ok(vec![])
    }
    async fn update_cost_adjustment_status(
        ...
        _status: &str,
        _approved_by: Option<Uuid>,
        _created_transaction_id: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::ProjectCostAdjustment> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::ProjectCostDistribution>> {
        Ok(vec![])
    }
    ...
    async fn mark_distribution_posted(
        &self,
        _id: Uuid,
        _gl_batch_id: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::ProjectCostDistribution> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }

    async fn get_costing_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::ProjectCostingSummary> {
        Ok(atlas_shared::ProjectCostingSummary {
            project_count: 0,
            total_raw_costs: "0".to_string(),
            total_burdened_costs: "0".to_string(),
            total_burden: "0".to_string(),
            total_capitalized: "0".to_string(),
...
impl crate::withholding_tax::WithholdingTaxRepository for MockWithholdingTaxRepository {
    ...
    async fn get_tax_code(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::WithholdingTaxCode>> {
        Ok(None)
    }
    async fn get_tax_code_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::WithholdingTaxCode>> {
        Ok(None)
    ...
    async fn list_tax_codes(
        &self,
        _org_id: Uuid,
        _tax_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::WithholdingTaxCode>> {
        Ok(vec![])
    }
    async fn delete_tax_code(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_tax_group(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::WithholdingTaxGroup>> {
        Ok(None)
    }
    async fn get_tax_group_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::WithholdingTaxGroup>> {
        Ok(None)
    }
    async fn list_tax_groups(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::WithholdingTaxGroup>> {
        Ok(vec![])
    }
    async fn delete_tax_group(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn add_group_member(
        ...
        Ok(atlas_shared::WithholdingTaxGroupMember {
            ...
            group_id,
            tax_code_id,
            tax_code: "MOCK".to_string(),
            tax_code_name: "Mock Tax Code".to_string(),
    ...
    async fn list_group_members(
        &self,
        _group_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::WithholdingTaxGroupMember>> {
        Ok(vec![])
    }
    async fn remove_group_member(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_supplier_assignment(
        ...
        _org_id: Uuid,
        _supplier_id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SupplierWithholdingAssignment>> {
        Ok(None)
    }
    async fn list_supplier_assignments(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SupplierWithholdingAssignment>> {
        Ok(vec![])
    }
    async fn delete_supplier_assignment(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_withholding_line(
        ...
        Ok(atlas_shared::WithholdingTaxLine {
            ...
            organization_id: org_id,
            payment_id,
            payment_number: payment_number.map(String::from),
            invoice_id,
            invoice_number: invoice_number.map(String::from),
            supplier_id,
            supplier_name: supplier_name.map(String::from),
    ...
    async fn get_withholding_lines_by_payment(
        &self,
        _payment_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::WithholdingTaxLine>> {
        Ok(vec![])
    }
    async fn get_withholding_lines_by_supplier(
        ...
        _to_date: Option<chrono::NaiveDate>,
    ) -> AtlasResult<Vec<atlas_shared::WithholdingTaxLine>> {
        Ok(vec![])
    }
    async fn update_withholding_line_status(
        ...
        _id: Uuid,
        _status: &str,
        _remittance_date: Option<chrono::NaiveDate>,
        _remittance_reference: Option<&str>,
    ) -> AtlasResult<atlas_shared::WithholdingTaxLine> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn get_certificate(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::WithholdingCertificate>> {
        Ok(None)
    }
    ...
    async fn list_certificates(
        ...
        _org_id: Uuid,
        _supplier_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::WithholdingCertificate>> {
        Ok(vec![])
    }
...
#[async_trait]
impl crate::procurement_contracts::ProcurementContractRepository
    for MockProcurementContractRepository
{
    async fn create_contract_type(
        ...
        Ok(atlas_shared::ContractType {
            ...
            allow_amount_commitment,
            allow_quantity_commitment,
            allow_line_additions,
            allow_price_adjustment,
            allow_renewal,
            allow_termination,
            max_renewals,
    ...
    async fn get_contract_type(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::ContractType>> {
        Ok(None)
    }
    async fn get_contract_type_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::ContractType>> {
        Ok(None)
    }
    async fn list_contract_types(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ContractType>> {
        Ok(vec![])
    }
    async fn delete_contract_type(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_contract(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::ProcurementContract>> {
        Ok(None)
    }
    async fn get_contract_by_number(
        &self,
        _org_id: Uuid,
        _contract_number: &str,
    ) -> AtlasResult<Option<atlas_shared::ProcurementContract>> {
        Ok(None)
    }
    async fn list_contracts(
        ...
        _status: Option<&str>,
        _supplier_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::ProcurementContract>> {
        Ok(vec![])
    }
    async fn update_contract_status(
        &self,
    ...
    async fn update_contract_totals(
        &self,
        _id: Uuid,
        _total_committed: Option<&str>,
        _total_released: Option<&str>,
        _total_invoiced: Option<&str>,
        _line_count: Option<i32>,
        _milestone_count: Option<i32>,
    ) -> AtlasResult<atlas_shared::ProcurementContract> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn increment_renewal_count(
        &self,
        _id: Uuid,
    ) -> AtlasResult<atlas_shared::ProcurementContract> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    ...
    async fn create_contract_line(
        ...
        Ok(atlas_shared::ContractLine {
            ...
            delivery_date,
            supplier_part_number: supplier_part_number.map(String::from),
    ...
    async fn get_contract_line(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::ContractLine>> {
        Ok(None)
    }
    async fn list_contract_lines(
        &self,
        _contract_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ContractLine>> {
        Ok(vec![])
    }
    async fn delete_contract_line(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_milestone(
        ...
        Ok(atlas_shared::ContractMilestone {
            ...
            deliverable: deliverable.map(String::from),
            is_billable,
            approved_by: None,
            approved_at: None,
            notes: None,
    ...
    async fn get_milestone(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::ContractMilestone>> {
        Ok(None)
    }
    async fn list_milestones(
        &self,
        _contract_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ContractMilestone>> {
        Ok(vec![])
    }
    async fn update_milestone_status(
        ...
        _id: Uuid,
        _status: &str,
        _actual_date: Option<chrono::NaiveDate>,
    ) -> AtlasResult<atlas_shared::ContractMilestone> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn list_renewals(
        &self,
        _contract_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ContractRenewal>> {
        Ok(vec![])
    }
    ...
    async fn list_spend_entries(
        &self,
        _contract_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ContractSpend>> {
        Ok(vec![])
    }
}
...
impl crate::treasury::TreasuryRepository for MockTreasuryRepository {
    async fn create_counterparty(
        ...
        Ok(atlas_shared::TreasuryCounterparty {
            id: Uuid::new_v4(),
            organization_id: org_id,
            counterparty_code: counterparty_code.to_string(),
            name: name.to_string(),
            counterparty_type: counterparty_type.to_string(),
            country_code: country_code.map(String::from),
            credit_rating: credit_rating.map(String::from),
    ...
    async fn get_counterparty(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::TreasuryCounterparty>> {
        Ok(None)
    }
    async fn get_counterparty_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::TreasuryCounterparty>> {
        Ok(None)
    ...
    async fn list_counterparties(
        ...
        _org_id: Uuid,
        _active_only: bool,
    ) -> AtlasResult<Vec<atlas_shared::TreasuryCounterparty>> {
        Ok(vec![])
    }
    async fn delete_counterparty(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_deal(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::TreasuryDeal>> {
        Ok(None)
    }
    async fn get_deal_by_number(
        ...
        _org_id: Uuid,
        _deal_number: &str,
    ) -> AtlasResult<Option<atlas_shared::TreasuryDeal>> {
        Ok(None)
    }
    async fn list_deals(
        &self,
        ...
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::TreasuryDeal>> {
        Ok(vec![])
    }
    async fn update_deal_status(
        ...
        _id: Uuid,
        _status: &str,
        _authorized_by: Option<Uuid>,
        _settled_at: Option<chrono::DateTime<chrono::Utc>>,
        _matured_at: Option<chrono::DateTime<chrono::Utc>>,
    ) -> AtlasResult<atlas_shared::TreasuryDeal> {
        Err(atlas_shared::AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn update_deal_interest(
        &self,
        _id: Uuid,
        _accrued_interest: &str,
        _settlement_amount: Option<&str>,
    ) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn list_settlements(
        &self,
        _deal_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::TreasurySettlement>> {
        Ok(vec![])
    }
    ...
    async fn get_dashboard_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::TreasuryDashboardSummary> {
        Ok(atlas_shared::TreasuryDashboardSummary {
            total_active_deals: 0,
            total_investments: "0".to_string(),
            total_borrowings: "0".to_string(),
            total_fx_exposure: "0".to_string(),
            total_accrued_interest: "0".to_string(),
            deals_maturing_7_days: 0,
            deals_maturing_30_days: 0,
            investment_count: 0,
            borrowing_count: 0,
            fx_deal_count: 0,
...
impl crate::subscription::SubscriptionRepository for MockSubscriptionRepository {
    ...
    async fn create_product(
        ...
        _description: Option<&str>,
        _product_type: &str,
        _billing_frequency: &str,
        _default_duration_months: i32,
        _is_auto_renew: bool,
        _cancellation_notice_days: i32,
        _setup_fee: &str,
        _tier_type: &str,
        _created_by: Option<Uuid>,
        ...
        Ok(atlas_shared::SubscriptionProduct {
            id: Uuid::new_v4(),
            organization_id: _org_id,
            product_code: _product_code.to_string(),
            name: _name.to_string(),
            description: None,
            product_type: _product_type.to_string(),
            ...
            setup_fee: _setup_fee.to_string(),
            tier_type: _tier_type.to_string(),
            is_active: true,
            metadata: serde_json::json!({}),
            created_by: None,
            created_at: chrono::Utc::now(),
    ...
    async fn get_product(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::SubscriptionProduct>> {
        Ok(None)
    }
    ...
    async fn list_products(
        ...
        _org_id: Uuid,
        _active_only: bool,
    ) -> AtlasResult<Vec<atlas_shared::SubscriptionProduct>> {
        Ok(vec![])
    }
    async fn delete_product(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_price_tier(
        ...
        _org_id: Uuid,
        _product_id: Uuid,
        _tier_name: Option<&str>,
        _min_quantity: &str,
        _max_quantity: Option<&str>,
        _unit_price: &str,
        _discount_percent: &str,
        _currency_code: &str,
        _effective_from: Option<chrono::NaiveDate>,
        _effective_to: Option<chrono::NaiveDate>,
        ...
        Ok(atlas_shared::SubscriptionPriceTier {
            ...
            tier_name: None,
            min_quantity: _min_quantity.to_string(),
            max_quantity: None,
            unit_price: _unit_price.to_string(),
    ...
    async fn list_price_tiers(
        ...
        _org_id: Uuid,
        _product_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SubscriptionPriceTier>> {
        Ok(vec![])
    }
    ...
    async fn create_subscription(
        ...
        _end_date: Option<chrono::NaiveDate>,
        _renewal_date: Option<&chrono::NaiveDate>,
        _billing_frequency: &str,
        _billing_day_of_month: i32,
        _billing_alignment: &str,
        _currency_code: &str,
        _quantity: &str,
        _unit_price: &str,
        _list_price: &str,
        _discount_percent: &str,
        _setup_fee: &str,
        _recurring_amount: &str,
        _total_contract_value: &str,
        _total_billed: &str,
        _total_revenue_recognized: &str,
        _duration_months: i32,
        _is_auto_renew: bool,
        _cancellation_date: Option<chrono::NaiveDate>,
        _cancellation_reason: Option<&str>,
        _suspension_reason: Option<&str>,
        _sales_rep_id: Option<Uuid>,
        _sales_rep_name: Option<&str>,
        _gl_revenue_account: Option<&str>,
        _gl_deferred_account: Option<&str>,
        _created_by: Option<Uuid>,
        ...
        Ok(atlas_shared::Subscription {
            ...
            customer_name: _customer_name.map(String::from),
            product_id: _product_id,
            product_code: _product_code.map(String::from),
            product_name: _product_name.map(String::from),
            description: None,
            status: _status.to_string(),
            start_date: _start_date,
            end_date: _end_date,
            renewal_date: _renewal_date.copied(),
            billing_frequency: _billing_frequency.to_string(),
            ...
            unit_price: _unit_price.to_string(),
            list_price: _list_price.to_string(),
            discount_percent: _discount_percent.to_string(),
            setup_fee: _setup_fee.to_string(),
            recurring_amount: _recurring_amount.to_string(),
    ...
    async fn get_subscription(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::Subscription>> {
        Ok(None)
    }
    async fn get_subscription_by_number(
        &self,
        _org_id: Uuid,
        _number: &str,
    ) -> AtlasResult<Option<atlas_shared::Subscription>> {
        Ok(None)
    }
    async fn list_subscriptions(
        ...
        _status: Option<&str>,
        _customer_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::Subscription>> {
        Ok(vec![])
    }
    ...
    async fn create_amendment(
        ...
        _amendment_number: &str,
        _amendment_type: &str,
        _description: Option<&str>,
        _old_quantity: Option<&str>,
        _new_quantity: Option<&str>,
        _old_unit_price: Option<&str>,
        _new_unit_price: Option<&str>,
        _old_recurring_amount: Option<&str>,
        _new_recurring_amount: Option<&str>,
        _old_end_date: Option<&chrono::NaiveDate>,
        _new_end_date: Option<&chrono::NaiveDate>,
        _effective_date: chrono::NaiveDate,
        _proration_credit: &str,
        _proration_charge: &str,
        _status: &str,
        _created_by: Option<Uuid>,
        ...
        Ok(atlas_shared::SubscriptionAmendment {
            ...
            amendment_type: _amendment_type.to_string(),
            description: None,
            old_quantity: None,
            new_quantity: None,
            old_unit_price: None,
            new_unit_price: None,
            old_recurring_amount: None,
    ...
    async fn get_amendment(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SubscriptionAmendment>> {
        Ok(None)
    }
    async fn list_amendments(
        &self,
        _subscription_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SubscriptionAmendment>> {
        Ok(vec![])
    }
    ...
    async fn create_billing_line(
        ...
        _org_id: Uuid,
        _subscription_id: Uuid,
        _schedule_number: i32,
        _billing_date: chrono::NaiveDate,
        _period_start: chrono::NaiveDate,
        _period_end: chrono::NaiveDate,
        _amount: &str,
        _proration_amount: &str,
        _total_amount: &str,
        ...
        Ok(atlas_shared::SubscriptionBillingLine {
            ...
            organization_id: _org_id,
            subscription_id: _subscription_id,
            schedule_number: _schedule_number,
            billing_date: _billing_date,
            period_start: _period_start,
            period_end: _period_end,
            amount: _amount.to_string(),
            proration_amount: _proration_amount.to_string(),
            total_amount: _total_amount.to_string(),
            invoice_id: None,
            invoice_number: None,
            status: "pending".to_string(),
            paid_at: None,
    ...
    async fn list_billing_lines(
        &self,
        _subscription_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SubscriptionBillingLine>> {
        Ok(vec![])
    }
    ...
    async fn create_revenue_line(
        ...
        _org_id: Uuid,
        _subscription_id: Uuid,
        _billing_schedule_id: Option<Uuid>,
        _period_name: &str,
        _period_start: chrono::NaiveDate,
        _period_end: chrono::NaiveDate,
        _revenue_amount: &str,
        _deferred_amount: &str,
        _recognized_to_date: &str,
        _status: &str,
        ...
        Ok(atlas_shared::SubscriptionRevenueLine {
            ...
            organization_id: _org_id,
            subscription_id: _subscription_id,
            billing_schedule_id: _billing_schedule_id,
            period_name: _period_name.to_string(),
            period_start: _period_start,
            period_end: _period_end,
    ...
    async fn get_revenue_line(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SubscriptionRevenueLine>> {
        Ok(None)
    }
    async fn list_revenue_lines(
        &self,
        _subscription_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SubscriptionRevenueLine>> {
        Ok(vec![])
    }
    async fn update_revenue_line_status(
        &self,
        _id: Uuid,
        _status: &str,
    ) -> AtlasResult<atlas_shared::SubscriptionRevenueLine> {
    ...
    async fn get_dashboard_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::SubscriptionDashboardSummary> {
        Ok(atlas_shared::SubscriptionDashboardSummary {
            ...
            total_contract_value: "0".to_string(),
            total_billed: "0".to_string(),
...
impl crate::corporate_card::CorporateCardRepository for MockCorporateCardRepository {
    ...
    async fn get_program(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::CorporateCardProgram>> {
        Ok(None)
    }
    ...
    async fn list_programs(
        ...
        _org_id: Uuid,
        _active_only: bool,
    ) -> AtlasResult<Vec<atlas_shared::CorporateCardProgram>> {
        Ok(vec![])
    }
    ...
    async fn create_card(
        ...
        Ok(atlas_shared::CorporateCard {
            ...
            cardholder_id,
            cardholder_email: cardholder_email.map(String::from),
            department_id,
            department_name: department_name.map(String::from),
            status: status.to_string(),
            issue_date,
    ...
    async fn get_card(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::CorporateCard>> {
        Ok(None)
    }
    async fn get_card_by_masked_number(
        ...
        _org_id: Uuid,
        _masked: &str,
    ) -> AtlasResult<Option<atlas_shared::CorporateCard>> {
        Ok(None)
    }
    async fn list_cards(
        &self,
        ...
        _cardholder_id: Option<Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::CorporateCard>> {
        Ok(vec![])
    }
    ...
    async fn update_card_spend(&self, _id: Uuid, _amount: &str, _balance: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_transaction(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::CorporateCardTransaction>> {
        Ok(None)
    }
    ...
    async fn list_transactions(
        &self,
        _org_id: Uuid,
        _card_id: Option<Uuid>,
        _status: Option<&str>,
        _date_from: Option<chrono::NaiveDate>,
        _date_to: Option<chrono::NaiveDate>,
    ) -> AtlasResult<Vec<atlas_shared::CorporateCardTransaction>> {
        Ok(vec![])
    }
    async fn update_transaction_match(
        &self,
        _id: Uuid,
        _expense_report_id: Option<Uuid>,
        _expense_line_id: Option<Uuid>,
        _status: &str,
        _matched_by: Option<Uuid>,
        _match_confidence: Option<&str>,
    ) -> AtlasResult<atlas_shared::CorporateCardTransaction> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn update_transaction_dispute(
        ...
        _id: Uuid,
        _reason: Option<&str>,
        _dispute_date: Option<chrono::NaiveDate>,
    ...
    async fn get_statement(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::CorporateCardStatement>> {
        Ok(None)
    }
    async fn list_statements(
        ...
        _program_id: Option<Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::CorporateCardStatement>> {
        Ok(vec![])
    }
    async fn update_statement_counts(
        &self,
    ...
    async fn get_limit_override(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::CorporateCardLimitOverride>> {
        Ok(None)
    }
    async fn list_limit_overrides(
        ...
        _card_id: Option<Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::CorporateCardLimitOverride>> {
        Ok(vec![])
    }
    ...
    async fn get_dashboard_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::CorporateCardDashboardSummary> {
...
#[async_trait]
impl crate::financial_consolidation::FinancialConsolidationRepository
    for MockFinancialConsolidationRepository
{
    ...
    async fn get_ledger(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::ConsolidationLedger>> {
        Ok(None)
    }
    ...
    async fn list_ledgers(
        ...
        _org_id: Uuid,
        _active_only: bool,
    ) -> AtlasResult<Vec<atlas_shared::ConsolidationLedger>> {
        Ok(vec![])
    }
    ...
    async fn get_entity(
        ...
        _ledger_id: Uuid,
        _entity_code: &str,
    ) -> AtlasResult<Option<atlas_shared::ConsolidationEntity>> {
        Ok(None)
    }
    ...
    async fn list_entities(
        ...
        _ledger_id: Uuid,
        _active_only: bool,
    ) -> AtlasResult<Vec<atlas_shared::ConsolidationEntity>> {
        Ok(vec![])
    }
    ...
    async fn create_scenario(
        ...
        Ok(atlas_shared::ConsolidationScenario {
            ...
            translation_rate_type: translation_rate_type.map(String::from),
            total_entities: 0,
    ...
    async fn get_scenario(
        &self,
        _org_id: Uuid,
        _scenario_number: &str,
    ) -> AtlasResult<Option<atlas_shared::ConsolidationScenario>> {
        Ok(None)
    }
    ...
    async fn list_scenarios(
        &self,
        _org_id: Uuid,
        _ledger_id: Option<Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::ConsolidationScenario>> {
        Ok(vec![])
    }
    ...
    async fn update_scenario_totals(
        ...
        _id: Uuid,
        _total_entities: i32,
        _total_eliminations: i32,
        _total_adjustments: i32,
        _total_debits: &str,
        _total_credits: &str,
        _is_balanced: bool,
    ) -> AtlasResult<()> {
    ...
    async fn create_trial_balance_line(
        ...
        Ok(atlas_shared::ConsolidationTrialBalanceLine {
            ...
            scenario_id,
            entity_id,
            entity_code: entity_code.map(String::from),
            account_code: account_code.to_string(),
            account_name: account_name.map(String::from),
            account_type: account_type.map(String::from),
            financial_statement: financial_statement.map(String::from),
            local_debit: local_debit.to_string(),
            local_credit: local_credit.to_string(),
            local_balance: local_balance.to_string(),
            exchange_rate: exchange_rate.map(String::from),
            translated_debit: translated_debit.to_string(),
            translated_credit: translated_credit.to_string(),
            translated_balance: translated_balance.to_string(),
            elimination_debit: elimination_debit.to_string(),
            elimination_credit: elimination_credit.to_string(),
    ...
    async fn list_trial_balance(
        ...
        _scenario_id: Uuid,
        _entity_id: Option<Uuid>,
        _line_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::ConsolidationTrialBalanceLine>> {
        Ok(vec![])
    }
    async fn delete_trial_balance_by_scenario(&self, _scenario_id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_elimination_rule(
        ...
        _ledger_id: Uuid,
        _rule_code: &str,
    ) -> AtlasResult<Option<atlas_shared::ConsolidationEliminationRule>> {
        Ok(None)
    }
    async fn list_elimination_rules(
        ...
        _ledger_id: Uuid,
        _active_only: bool,
    ) -> AtlasResult<Vec<atlas_shared::ConsolidationEliminationRule>> {
        Ok(vec![])
    }
    ...
    async fn get_adjustment(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::ConsolidationAdjustment>> {
        Ok(None)
    }
    async fn list_adjustments(
        ...
        _scenario_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::ConsolidationAdjustment>> {
        Ok(vec![])
    }
    ...
    async fn get_translation_rate(
        ...
        _entity_id: Uuid,
        _rate_type: &str,
    ) -> AtlasResult<Option<atlas_shared::ConsolidationTranslationRate>> {
        Ok(None)
    }
    async fn list_translation_rates(
        &self,
        _scenario_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ConsolidationTranslationRate>> {
        Ok(vec![])
    }
    ...
    async fn get_dashboard_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::ConsolidationDashboardSummary> {
...
#[async_trait::async_trait]
impl crate::supplier_qualification::SupplierQualificationRepository
    for MockSupplierQualificationRepository
{
    async fn create_area(
        ...
        _passing_score: &str,
        _is_mandatory: bool,
        _renewal_period_days: i32,
        _created_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::QualificationArea> {
        Ok(atlas_shared::QualificationArea {
            id: Uuid::new_v4(),
            organization_id: _org_id,
            area_code: _area_code.to_string(),
            name: _name.to_string(),
            description: None,
            area_type: _area_type.to_string(),
            scoring_model: _scoring_model.to_string(),
            passing_score: _passing_score.to_string(),
            is_mandatory: _is_mandatory,
            renewal_period_days: _renewal_period_days,
            is_active: true,
            metadata: serde_json::json!({}),
            created_by: None,
            created_at: chrono::Utc::now(),
    ...
    async fn get_area(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::QualificationArea>> {
        Ok(None)
    }
    ...
    async fn list_areas(
        ...
        _org_id: Uuid,
        _active_only: bool,
    ) -> AtlasResult<Vec<atlas_shared::QualificationArea>> {
        Ok(vec![])
    }
    async fn delete_area(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_question(
        ...
        _org_id: Uuid,
        _area_id: Uuid,
        _question_number: i32,
        _question_text: &str,
        _description: Option<&str>,
        _response_type: &str,
        _choices: Option<serde_json::Value>,
        _is_required: bool,
        _weight: &str,
        _max_score: &str,
        _help_text: Option<&str>,
        _display_order: i32,
        ...
        Ok(atlas_shared::QualificationQuestion {
            ...
            question_text: _question_text.to_string(),
            description: None,
            response_type: _response_type.to_string(),
            choices: None,
            is_required: _is_required,
            weight: _weight.to_string(),
            max_score: _max_score.to_string(),
            help_text: None,
    ...
    async fn list_questions(
        &self,
        _area_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::QualificationQuestion>> {
        Ok(vec![])
    }
    async fn delete_question(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_initiative(
        &self,
        _org_id: Uuid,
        _initiative_number: &str,
        _name: &str,
        _description: Option<&str>,
        _area_id: Uuid,
        _qualification_purpose: &str,
        ...
        Ok(atlas_shared::SupplierQualificationInitiative {
            id: Uuid::new_v4(),
            organization_id: _org_id,
            initiative_number: _initiative_number.to_string(),
            name: _name.to_string(),
            description: None,
            area_id: _area_id,
            qualification_purpose: _qualification_purpose.to_string(),
            status: "draft".to_string(),
            deadline: None,
            total_invited: 0,
            total_responded: 0,
    ...
    async fn get_initiative(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SupplierQualificationInitiative>> {
        Ok(None)
    }
    async fn list_initiatives(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::SupplierQualificationInitiative>> {
        Ok(vec![])
    }
    ...
    async fn create_invitation(
        ...
        _supplier_id: Uuid,
        _supplier_name: &str,
        _supplier_contact_name: Option<&str>,
        _supplier_contact_email: Option<&str>,
        ...
        Ok(atlas_shared::SupplierQualificationInvitation {
            ...
            supplier_name: _supplier_name.to_string(),
            ...
            max_possible_score: "0".to_string(),
            score_percentage: "0".to_string(),
            qualified_by: None,
    ...
    async fn get_invitation(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SupplierQualificationInvitation>> {
        Ok(None)
    }
    async fn list_invitations_by_initiative(
        &self,
        _initiative_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SupplierQualificationInvitation>> {
        Ok(vec![])
    }
    ...
    async fn update_invitation_status(
        ...
        _id: Uuid,
        _status: &str,
        _response_date: Option<chrono::DateTime<chrono::Utc>>,
        _evaluation_date: Option<chrono::DateTime<chrono::Utc>>,
    ) -> AtlasResult<atlas_shared::SupplierQualificationInvitation> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn update_invitation_scores(
        ...
        _id: Uuid,
        _overall_score: &str,
        _max_possible_score: &str,
        _score_percentage: &str,
        _qualified_by: Option<Uuid>,
        _disqualified_reason: Option<&str>,
        _evaluation_notes: Option<&str>,
    ) -> AtlasResult<atlas_shared::SupplierQualificationInvitation> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn create_response(
        ...
        _response_value: Option<serde_json::Value>,
        _file_reference: Option<&str>,
        ...
        Ok(atlas_shared::SupplierQualificationResponse {
            ...
            response_text: _response_text.map(String::from),
            response_value: None,
            file_reference: None,
            score: "0".to_string(),
            max_score: "0".to_string(),
    ...
    async fn get_response(
        ...
        _invitation_id: Uuid,
        _question_id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SupplierQualificationResponse>> {
        Ok(None)
    }
    async fn list_responses(
        &self,
        _invitation_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SupplierQualificationResponse>> {
        Ok(vec![])
    }
    ...
    async fn create_certification(
        ...
        _supplier_id: Uuid,
        _supplier_name: &str,
        _certification_type: &str,
        _certification_name: &str,
        _certifying_body: Option<&str>,
        _certificate_number: Option<&str>,
        _status: &str,
        _issued_date: Option<chrono::NaiveDate>,
        _expiry_date: Option<chrono::NaiveDate>,
        _renewal_date: Option<chrono::NaiveDate>,
        _qualification_invitation_id: Option<Uuid>,
        _document_reference: Option<&str>,
        _notes: Option<&str>,
        _created_by: Option<Uuid>,
        ...
        Ok(atlas_shared::SupplierCertification {
            ...
            supplier_id: _supplier_id,
            supplier_name: _supplier_name.to_string(),
            certification_type: _certification_type.to_string(),
            certification_name: _certification_name.to_string(),
            ...
            expiry_date: None,
            renewal_date: None,
            qualification_invitation_id: None,
    ...
    async fn get_certification(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SupplierCertification>> {
        Ok(None)
    }
    async fn list_certifications(
        ...
        _supplier_id: Option<Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::SupplierCertification>> {
        Ok(vec![])
    }
    ...
    async fn get_dashboard_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::SupplierQualificationDashboardSummary> {
        Ok(atlas_shared::SupplierQualificationDashboardSummary {
            total_active_areas: 0,
            total_active_initiatives: 0,
            total_suppliers_invited: 0,
            total_suppliers_qualified: 0,
            total_suppliers_pending: 0,
            total_suppliers_disqualified: 0,
            total_certifications_active: 0,
            total_certifications_expiring_30_days: 0,
            qualification_rate_percent: "0".to_string(),
...
impl SegregationOfDutiesRepository for MockSegregationOfDutiesRepository {
    ...
    async fn get_rule(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::SodRule>> {
        Ok(None)
    }
    async fn get_rule_by_id(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::SodRule>> {
        Ok(None)
    }
    async fn list_rules(
        &self,
        _org_id: Uuid,
        _active_only: bool,
    ) -> AtlasResult<Vec<atlas_shared::SodRule>> {
        Ok(vec![])
    }
    ...
    async fn delete_rule(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_role_assignments_for_user(
        &self,
        _org_id: Uuid,
        _user_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SodRoleAssignment>> {
        Ok(vec![])
    }
    ...
    async fn create_violation(
        ...
        Ok(atlas_shared::SodViolation {
            ...
            rule_code: rule_code.to_string(),
            user_id,
            first_matched_duties,
            second_matched_duties,
    ...
    async fn get_violation(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::SodViolation>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::SodViolation>> {
        Ok(vec![])
    }
    ...
    async fn find_existing_violation(
        ...
        _rule_id: Uuid,
        _user_id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SodViolation>> {
        Ok(None)
    }
    ...
    async fn create_mitigating_control(
        ...
        Ok(atlas_shared::SodMitigatingControl {
            ...
            control_owner_id,
            review_frequency: review_frequency.to_string(),
            effective_from,
            effective_to,
            approved_by: None,
            approved_at: None,
    ...
    async fn get_mitigating_controls_for_violation(
        &self,
        _violation_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SodMitigatingControl>> {
        Ok(vec![])
    }
    async fn list_mitigating_controls(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::SodMitigatingControl>> {
        Ok(vec![])
    }
    async fn approve_mitigating_control(
        &self,
        _id: Uuid,
        _approved_by: Uuid,
    ) -> AtlasResult<atlas_shared::SodMitigatingControl> {
    ...
    async fn revoke_mitigating_control(
        &self,
        _id: Uuid,
    ) -> AtlasResult<atlas_shared::SodMitigatingControl> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
...
impl AutoInvoiceRepository for MockAutoInvoiceRepository {
    ...
    async fn get_grouping_rule(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::AutoInvoiceGroupingRule>> {
        Ok(None)
    }
    ...
    async fn list_grouping_rules(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::AutoInvoiceGroupingRule>> {
        Ok(vec![])
    }
    async fn delete_grouping_rule(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::AutoInvoiceValidationRule>> {
        Ok(vec![])
    }
    ...
    async fn delete_validation_rule(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_batch(
        ...
        Ok(atlas_shared::AutoInvoiceBatch {
            ...
            invalid_lines: 0,
            invoices_created: 0,
            invoices_total_amount: "0".to_string(),
            grouping_rule_id,
    ...
    async fn get_batch(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::AutoInvoiceBatch>> {
        Ok(None)
    }
    async fn get_batch_by_number(
        ...
        _org_id: Uuid,
        _batch_number: &str,
    ) -> AtlasResult<Option<atlas_shared::AutoInvoiceBatch>> {
        Ok(None)
    }
    async fn list_batches(
        &self,
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::AutoInvoiceBatch>> {
        Ok(vec![])
    }
    async fn update_batch_status(
        &self,
    ...
    async fn update_batch_counts(
        ...
        _valid_lines: i32,
        _invalid_lines: i32,
        _invoices_created: i32,
        _invoices_total_amount: &str,
        _validation_errors: serde_json::Value,
    ) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_line(
        ...
        Ok(atlas_shared::AutoInvoiceLine {
            ...
            ship_to_site_id,
            item_code: item_code.map(String::from),
            item_description: item_description.map(String::from),
            quantity: quantity.map(String::from),
            unit_of_measure: unit_of_measure.map(String::from),
            unit_price: unit_price.to_string(),
            line_amount: line_amount.to_string(),
            ...
            tax_amount: tax_amount.map(String::from),
            sales_rep_id,
            sales_rep_name: sales_rep_name.map(String::from),
            memo_line: memo_line.map(String::from),
            reference_number: reference_number.map(String::from),
    ...
    async fn get_line(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::AutoInvoiceLine>> {
        Ok(None)
    }
    async fn list_lines_by_batch(
        &self,
        _batch_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::AutoInvoiceLine>> {
        Ok(vec![])
    }
    ...
    async fn get_result(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::AutoInvoiceResult>> {
        Ok(None)
    }
    async fn get_result_by_invoice_number(
        ...
        _org_id: Uuid,
        _invoice_number: &str,
    ) -> AtlasResult<Option<atlas_shared::AutoInvoiceResult>> {
        Ok(None)
    }
    async fn list_results_by_batch(
        &self,
        _batch_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::AutoInvoiceResult>> {
        Ok(vec![])
    }
    ...
    async fn list_result_lines(
        &self,
        _invoice_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::AutoInvoiceResultLine>> {
        Ok(vec![])
    }
    ...
    async fn get_summary(&self, _org_id: Uuid) -> AtlasResult<atlas_shared::AutoInvoiceSummary> {
        Ok(atlas_shared::AutoInvoiceSummary {
            ...
            total_invoice_amount: "0".to_string(),
        })
    }
}
...
impl ProductInformationRepository for MockProductInformationRepository {
    async fn create_item(
        ...
        Ok(atlas_shared::ProductItem {
            ...
            weight_uom: weight_uom.map(String::from),
    ...
    async fn get_item(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ProductItem>> {
        Ok(None)
    }
    async fn get_item_by_number(
        ...
        _org_id: Uuid,
        _item_number: &str,
    ) -> AtlasResult<Option<atlas_shared::ProductItem>> {
        Ok(None)
    }
    async fn list_items(
        &self,
        ...
        _category_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::ProductItem>> {
        Ok(vec![])
    }
    async fn update_item_status(
        ...
        Ok(atlas_shared::ProductItem {
            ...
            item_number: "MOCK".to_string(),
            item_name: "Mock".to_string(),
            description: None,
            long_description: None,
            item_type: "finished_good".to_string(),
            status: status.to_string(),
            lifecycle_phase: lifecycle_phase.unwrap_or("concept").to_string(),
            primary_uom_code: "EA".to_string(),
            secondary_uom_code: None,
            weight: None,
            weight_uom: None,
            volume: None,
            volume_uom: None,
            hazmat_flag: false,
            lot_control_flag: false,
            serial_control_flag: false,
    ...
    async fn delete_item(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_category(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::PimCategory>> {
        Ok(None)
    }
    async fn get_category_by_code(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::PimCategory>> {
        Ok(None)
    }
    async fn list_categories(
        &self,
    ...
    ) -> AtlasResult<Vec<atlas_shared::PimCategory>> {
        Ok(vec![])
    }
    async fn delete_category(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_primary_category_assignment(
        &self,
        _item_id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::PimCategoryAssignment>> {
        Ok(None)
    }
    async fn list_item_categories(
        &self,
        _item_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PimCategoryAssignment>> {
        Ok(vec![])
    }
    async fn remove_item_category(&self, _assignment_id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_cross_reference_by_value(
        ...
        _xref_type: &str,
        _value: &str,
    ) -> AtlasResult<Option<atlas_shared::PimCrossReference>> {
        Ok(None)
    }
    async fn list_cross_references(
        &self,
        _item_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PimCrossReference>> {
        Ok(vec![])
    }
    async fn list_all_cross_references(
        &self,
        _org_id: Uuid,
        _xref_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::PimCrossReference>> {
        Ok(vec![])
    }
    async fn delete_cross_reference(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_template(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::PimItemTemplate>> {
        Ok(None)
    }
    async fn get_template_by_code(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::PimItemTemplate>> {
        Ok(None)
    }
    async fn list_templates(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PimItemTemplate>> {
        Ok(vec![])
    }
    async fn delete_template(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_new_item_request(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::PimNewItemRequest>> {
        Ok(None)
    }
    async fn list_new_item_requests(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::PimNewItemRequest>> {
        Ok(vec![])
    }
    ...
    async fn get_dashboard(&self, _org_id: Uuid) -> AtlasResult<atlas_shared::PimDashboard> {
        Ok(atlas_shared::PimDashboard {
            ...
            total_categories: 0,
            pending_nir_count: 0,
            approved_nir_count: 0,
            cross_reference_count: 0,
            recently_created_items: 0,
...
impl crate::absence::AbsenceRepository for MockAbsenceRepository {
    async fn create_absence_type(
        ...
        _requires_documentation: bool,
        _auto_approve_below_days: &str,
        _allow_negative_balance: bool,
        _allow_half_day: bool,
        _created_by: Option<Uuid>,
    ...
    async fn get_absence_type(
        &self,
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::AbsenceType>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::AbsenceType>> {
        Ok(vec![])
    }
    async fn delete_absence_type(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_absence_plan(
        ...
        _name: &str,
        _description: Option<&str>,
        _absence_type_id: Uuid,
        _accrual_frequency: &str,
        _accrual_rate: &str,
        _accrual_unit: &str,
        _carry_over_max: Option<String>,
        _carry_over_expiry_months: Option<i32>,
        _max_balance: Option<String>,
        _probation_period_days: i32,
        _prorate_first_year: bool,
        _created_by: Option<Uuid>,
        ...
        Ok(atlas_shared::AbsencePlan {
            ...
            accrual_frequency: _accrual_frequency.to_string(),
            accrual_rate: _accrual_rate.to_string(),
            accrual_unit: _accrual_unit.to_string(),
            carry_over_max: _carry_over_max,
            carry_over_expiry_months: _carry_over_expiry_months,
            max_balance: _max_balance,
            probation_period_days: _probation_period_days,
            prorate_first_year: _prorate_first_year,
            is_active: true,
            metadata: serde_json::json!({}),
            created_by: _created_by,
            created_at: chrono::Utc::now(),
    ...
    async fn get_absence_plan(
        &self,
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::AbsencePlan>> {
        Ok(None)
    }
    async fn get_plan_by_id(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::AbsencePlan>> {
        Ok(None)
    }
    async fn list_absence_plans(
        &self,
        _org_id: Uuid,
        _absence_type_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::AbsencePlan>> {
        Ok(vec![])
    }
    async fn delete_absence_plan(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_entry(
        &self,
        ...
        _duration_days: &str,
        _duration_hours: Option<String>,
        _is_half_day: bool,
        _half_day_period: Option<&str>,
        _reason: Option<&str>,
        _comments: Option<&str>,
        _documentation_provided: bool,
        _approved_by: Option<&str>,
        _created_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::AbsenceEntry> {
        todo!()
    }
    async fn get_entry(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::AbsenceEntry>> {
        Ok(None)
    }
    async fn list_entries(
        &self,
        ...
        _absence_type_id: Option<Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::AbsenceEntry>> {
        Ok(vec![])
    }
    async fn update_entry_status(
        &self,
    ...
    async fn create_balance(
        ...
        _carried_over: &str,
        _remaining: &str,
    ) -> AtlasResult<atlas_shared::AbsenceBalance> {
        todo!()
    }
    async fn get_balance(
        &self,
        ...
        _period_start: chrono::NaiveDate,
        _period_end: chrono::NaiveDate,
    ) -> AtlasResult<Option<atlas_shared::AbsenceBalance>> {
        Ok(None)
    }
    async fn get_balance_for_previous_period(
        ...
        _employee_id: Uuid,
        _plan_id: Uuid,
        _current_period_start: chrono::NaiveDate,
    ) -> AtlasResult<Option<atlas_shared::AbsenceBalance>> {
        Ok(None)
    }
    async fn list_balances(
        ...
        _org_id: Uuid,
        _employee_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::AbsenceBalance>> {
        Ok(vec![])
    }
    ...
    async fn get_entry_history(
        &self,
        _entry_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::AbsenceEntryHistory>> {
        Ok(vec![])
    }
}
...
impl crate::time_and_labor::TimeAndLaborRepository for MockTimeAndLaborRepository {
    async fn create_work_schedule(
        ...
        _description: Option<&str>,
        _schedule_type: &str,
        _standard_hours_per_day: &str,
        _standard_hours_per_week: &str,
        _work_days_per_week: i32,
        _start_time: Option<chrono::NaiveTime>,
        _end_time: Option<chrono::NaiveTime>,
        _break_duration_minutes: i32,
        _created_by: Option<Uuid>,
        ...
        Ok(atlas_shared::WorkSchedule {
            ...
            start_time: None,
            end_time: None,
            break_duration_minutes: _break_duration_minutes,
            is_active: true,
            metadata: serde_json::json!({}),
            created_by: None,
            created_at: chrono::Utc::now(),
    ...
    async fn get_work_schedule(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::WorkSchedule>> {
        Ok(None)
    }
    ...
    async fn list_work_schedules(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::WorkSchedule>> {
        Ok(vec![])
    }
    async fn delete_work_schedule(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_overtime_rule(
        ...
        _description: Option<&str>,
        _threshold_type: &str,
        _daily_threshold_hours: &str,
        _weekly_threshold_hours: &str,
        _overtime_multiplier: &str,
        _double_time_threshold_hours: Option<&str>,
        _double_time_multiplier: &str,
        _include_holidays: bool,
        _include_weekends: bool,
        _effective_from: Option<chrono::NaiveDate>,
        _effective_to: Option<chrono::NaiveDate>,
        _created_by: Option<Uuid>,
    ...
    async fn get_overtime_rule(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::OvertimeRule>> {
        Ok(None)
    }
    async fn get_overtime_rule_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::OvertimeRule>> {
        Ok(None)
    }
    async fn list_overtime_rules(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::OvertimeRule>> {
        Ok(vec![])
    }
    async fn delete_overtime_rule(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_time_card(
        ...
        Ok(atlas_shared::TimeCard {
            ...
            employee_name: _employee_name.map(String::from),
            card_number: _card_number.to_string(),
            status: "draft".to_string(),
            period_start: _period_start,
            period_end: _period_end,
            total_regular_hours: "0.0000".to_string(),
            total_overtime_hours: "0.0000".to_string(),
            total_double_time_hours: "0.0000".to_string(),
            total_hours: "0.0000".to_string(),
            schedule_id: None,
    ...
    async fn get_time_card(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::TimeCard>> {
        Ok(None)
    }
    async fn get_time_card_by_number(
        ...
        _org_id: Uuid,
        _card_number: &str,
    ) -> AtlasResult<Option<atlas_shared::TimeCard>> {
        Ok(None)
    }
    async fn list_time_cards(
        ...
        _employee_id: Option<Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::TimeCard>> {
        Ok(vec![])
    }
    ...
    async fn create_time_entry(
        ...
        Ok(atlas_shared::TimeEntry {
            id: Uuid::new_v4(),
            organization_id: _org_id,
            time_card_id: _time_card_id,
            entry_date: _entry_date,
            entry_type: _entry_type.to_string(),
            start_time: None,
            end_time: None,
            duration_hours: _duration_hours.to_string(),
            project_id: None,
            project_name: None,
            department_id: None,
    ...
    async fn get_time_entry(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::TimeEntry>> {
        Ok(None)
    }
    async fn list_time_entries_by_card(
        &self,
        _time_card_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::TimeEntry>> {
        Ok(vec![])
    }
    async fn delete_time_entry(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    async fn add_history(
        &self,
    ...
    async fn get_time_card_history(
        &self,
        _time_card_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::TimeCardHistory>> {
        Ok(vec![])
    }
    ...
    async fn list_labor_distributions_by_entry(
        &self,
        _time_entry_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::LaborDistribution>> {
        Ok(vec![])
    }
    async fn delete_labor_distribution(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_labor_distribution(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::LaborDistribution>> {
        Ok(None)
    }
}
...
impl crate::payroll::PayrollRepository for MockPayrollRepository {
    async fn create_payroll(
        ...
        _pay_frequency: &str,
        _currency_code: &str,
        _salary_expense_account: Option<&str>,
        _liability_account: Option<&str>,
        _employer_tax_account: Option<&str>,
        _payment_account: Option<&str>,
        _created_by: Option<Uuid>,
    ...
    async fn get_payroll(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::PayrollDefinition>> {
        Ok(None)
    }
    async fn get_payroll_by_name(
        ...
        _org_id: Uuid,
        _name: &str,
    ) -> AtlasResult<Option<atlas_shared::PayrollDefinition>> {
        Ok(None)
    }
    async fn list_payrolls(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PayrollDefinition>> {
        Ok(vec![])
    }
    async fn delete_payroll(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_element(
        ...
        _element_type: &str,
        _category: &str,
        _calculation_method: &str,
        _default_value: Option<&str>,
        _is_recurring: bool,
        _has_employer_contribution: bool,
        _employer_contribution_rate: Option<&str>,
        _gl_account_code: Option<&str>,
        _is_pretax: bool,
        _effective_from: Option<chrono::NaiveDate>,
        _effective_to: Option<chrono::NaiveDate>,
        ...
        Ok(atlas_shared::PayrollElement {
            ...
            employer_contribution_rate: _employer_contribution_rate
                .map(std::string::ToString::to_string),
            gl_account_code: None,
            is_pretax: _is_pretax,
            is_active: true,
            effective_from: None,
            effective_to: None,
            created_by: None,
    ...
    async fn get_element(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::PayrollElement>> {
        Ok(None)
    }
    async fn get_element_by_code(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::PayrollElement>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::PayrollElement>> {
        Ok(vec![])
    }
    async fn delete_element(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_entry(
        &self,
        ...
        Ok(atlas_shared::PayrollElementEntry {
            ...
            remaining_periods: _remaining_periods,
            is_active: true,
            effective_from: None,
            effective_to: None,
            created_by: None,
    ...
    async fn get_entries_by_employee(
        &self,
        _employee_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PayrollElementEntry>> {
        Ok(vec![])
    }
    async fn delete_entry(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_run(
        &self,
        ...
        Ok(atlas_shared::PayrollRun {
            ...
            run_number: _run_number.to_string(),
            status: "open".to_string(),
            period_start: _period_start,
            period_end: _period_end,
            pay_date: _pay_date,
            total_gross: "0".to_string(),
            total_deductions: "0".to_string(),
            total_net: "0".to_string(),
            total_employer_cost: "0".to_string(),
            employee_count: 0,
            confirmed_by: None,
            confirmed_at: None,
            paid_by: None,
    ...
    async fn get_run(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::PayrollRun>> {
        Ok(None)
    }
    async fn get_run_by_number(
        ...
        _org_id: Uuid,
        _run_number: &str,
    ) -> AtlasResult<Option<atlas_shared::PayrollRun>> {
        Ok(None)
    }
    async fn list_runs(
        &self,
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::PayrollRun>> {
        Ok(vec![])
    }
    ...
    async fn update_run_totals(
        ...
        _id: Uuid,
        _total_gross: &str,
        _total_deductions: &str,
        _total_net: &str,
        _total_employer_cost: &str,
        _employee_count: i32,
    ) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_pay_slip(
        ...
        _bank_account_last4: Option<&str>,
    ...
    async fn get_pay_slip(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::PaySlip>> {
        Ok(None)
    }
    async fn list_pay_slips_by_run(
        &self,
        _payroll_run_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PaySlip>> {
        Ok(vec![])
    }
    async fn list_pay_slips_by_employee(
        &self,
        _employee_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PaySlip>> {
        Ok(vec![])
    ...
    async fn create_pay_slip_line(
        ...
        Ok(atlas_shared::PaySlipLine {
            ...
            amount: _amount.to_string(),
            is_pretax: _is_pretax,
            is_employer: _is_employer,
            gl_account_code: None,
            created_at: chrono::Utc::now(),
        })
    }
    async fn list_pay_slip_lines(
        &self,
        _pay_slip_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::PaySlipLine>> {
        Ok(vec![])
    }
...
impl crate::joint_venture::JointVentureRepository for MockJointVentureRepository {
    async fn create_venture(
        ...
        Ok(atlas_shared::JointVenture {
            ...
            status: "draft".to_string(),
            operator_id,
            operator_name: operator_name.map(String::from),
            currency_code: currency_code.to_string(),
            start_date,
            end_date,
    ...
    async fn get_venture(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::JointVenture>> {
        Ok(None)
    }
    async fn get_venture_by_number(
        ...
        _org_id: Uuid,
        _venture_number: &str,
    ) -> AtlasResult<Option<atlas_shared::JointVenture>> {
        Ok(None)
    }
    async fn list_ventures(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::JointVenture>> {
        Ok(vec![])
    }
    async fn update_venture_status(
        &self,
        _id: Uuid,
        _status: &str,
    ) -> AtlasResult<atlas_shared::JointVenture> {
    ...
    async fn get_partner(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::JointVenturePartner>> {
        Ok(None)
    }
    async fn list_partners_by_venture(
        &self,
        _venture_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::JointVenturePartner>> {
        Ok(vec![])
    }
    ...
    async fn delete_partner(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_afe(
        ...
        Ok(atlas_shared::JointVentureAfe {
            ...
            organization_id: org_id,
            venture_id,
            afe_number: afe_number.to_string(),
            title: title.to_string(),
            description: description.map(String::from),
            status: "draft".to_string(),
    ...
    async fn get_afe(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::JointVentureAfe>> {
        Ok(None)
    }
    async fn get_afe_by_number(
        ...
        _org_id: Uuid,
        _afe_number: &str,
    ) -> AtlasResult<Option<atlas_shared::JointVentureAfe>> {
        Ok(None)
    }
    async fn list_afes_by_venture(
        ...
        _venture_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::JointVentureAfe>> {
        Ok(vec![])
    }
    ...
    async fn get_cost_distribution(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::JvCostDistribution>> {
        Ok(None)
    }
    async fn list_cost_distributions(
        &self,
        _venture_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::JvCostDistribution>> {
        Ok(vec![])
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::JvCostDistributionLine>> {
        Ok(vec![])
    }
    ...
    async fn get_revenue_distribution(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::JvRevenueDistribution>> {
        Ok(None)
    }
    async fn list_revenue_distributions(
        ...
        _venture_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::JvRevenueDistribution>> {
        Ok(vec![])
    }
    ...
    async fn list_revenue_distribution_lines(
        &self,
        _distribution_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::JvRevenueDistributionLine>> {
        Ok(vec![])
    }
    ...
    async fn get_billing(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::JvBilling>> {
        Ok(None)
    }
    async fn get_billing_by_number(
        ...
        _org_id: Uuid,
        _billing_number: &str,
    ) -> AtlasResult<Option<atlas_shared::JvBilling>> {
        Ok(None)
    }
    async fn list_billings(
        ...
        _venture_id: Uuid,
        _status: Option<&str>,
        _billing_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::JvBilling>> {
        Ok(vec![])
    }
    ...
    async fn list_billing_lines(
        &self,
        _billing_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::JvBillingLine>> {
        Ok(vec![])
    }
...
impl crate::sustainability::SustainabilityRepository for MockSustainabilityRepository {
    ...
    async fn get_facility(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SustainabilityFacility>> {
        Ok(None)
    }
    async fn get_facility_by_code(
        &self,
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::SustainabilityFacility>> {
    ...
    async fn list_facilities(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _facility_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::SustainabilityFacility>> {
        Ok(vec![])
    }
    ...
    async fn delete_facility(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_emission_factor(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EmissionFactor>> {
        Ok(None)
    }
    async fn get_emission_factor_by_code(
        &self,
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::EmissionFactor>> {
    ...
    async fn list_emission_factors(
        &self,
        _org_id: Uuid,
        _scope: Option<&str>,
        _category: Option<&str>,
        _activity_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::EmissionFactor>> {
        Ok(vec![])
    }
    async fn delete_emission_factor(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_activity(
        ...
        Ok(atlas_shared::EnvironmentalActivity {
            ...
            n2o_kg,
            cost_amount,
            cost_currency: cost_currency.map(String::from),
            activity_date,
            reporting_period: reporting_period.map(String::from),
            source_type: source_type.map(String::from),
            source_reference: source_reference.map(String::from),
            department_id,
            project_id,
    ...
    async fn get_activity(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EnvironmentalActivity>> {
        Ok(None)
    }
    async fn get_activity_by_number(
        &self,
        _org_id: Uuid,
        _number: &str,
    ) -> AtlasResult<Option<atlas_shared::EnvironmentalActivity>> {
    ...
    async fn list_activities(
        ...
        _activity_type: Option<&str>,
        _period: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::EnvironmentalActivity>> {
        Ok(vec![])
    }
    ...
    async fn delete_activity(&self, _org_id: Uuid, _number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_metric(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::EsgMetric>> {
        Ok(None)
    }
    async fn get_metric_by_code(
        &self,
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::EsgMetric>> {
        Ok(None)
    }
    async fn list_metrics(
        ...
        _pillar: Option<&str>,
        _category: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::EsgMetric>> {
        Ok(vec![])
    }
    async fn delete_metric(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_metric_reading(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EsgMetricReading>> {
        Ok(None)
    }
    async fn list_metric_readings(
        &self,
        _metric_id: Uuid,
        _from: Option<chrono::NaiveDate>,
        _to: Option<chrono::NaiveDate>,
    ) -> AtlasResult<Vec<atlas_shared::EsgMetricReading>> {
        Ok(vec![])
    }
    async fn delete_metric_reading(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_goal(
        ...
        Ok(atlas_shared::SustainabilityGoal {
            ...
            baseline_value,
            baseline_year,
            baseline_unit: baseline_unit.to_string(),
            target_value,
            target_year,
    ...
    async fn get_goal(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::SustainabilityGoal>> {
        Ok(None)
    }
    async fn get_goal_by_code(
        &self,
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::SustainabilityGoal>> {
        Ok(None)
    }
    async fn list_goals(
        &self,
        _org_id: Uuid,
        _goal_type: Option<&str>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::SustainabilityGoal>> {
        Ok(vec![])
    }
    ...
    async fn delete_goal(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_carbon_offset(
        ...
        Ok(atlas_shared::CarbonOffset {
            id: Uuid::new_v4(),
            organization_id: org_id,
            offset_number: offset_number.to_string(),
            name: name.to_string(),
            description: description.map(String::from),
            ...
            unit_price,
            total_cost,
            currency_code: currency_code.map(String::from),
            vintage_year,
    ...
    async fn get_carbon_offset(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::CarbonOffset>> {
        Ok(None)
    }
    async fn get_offset_by_number(
        &self,
        _org_id: Uuid,
        _number: &str,
    ) -> AtlasResult<Option<atlas_shared::CarbonOffset>> {
    ...
    async fn list_carbon_offsets(
        &self,
        _org_id: Uuid,
        _status: Option<&str>,
        _project_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::CarbonOffset>> {
        Ok(vec![])
    }
    async fn retire_carbon_offset(
        &self,
        _id: Uuid,
        _qty: f64,
    ) -> AtlasResult<atlas_shared::CarbonOffset> {
    ...
    async fn delete_carbon_offset(&self, _org_id: Uuid, _number: &str) -> AtlasResult<()> {
        Ok(())
    }
...
impl EngineeringChangeManagementRepository for MockEngineeringChangeManagementRepository {
    ...
    async fn get_change_type(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EngineeringChangeType>> {
        Ok(None)
    }
    async fn get_change_type_by_code(
        &self,
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::EngineeringChangeType>> {
    ...
    async fn list_change_types(
        &self,
        _org_id: Uuid,
        _category: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::EngineeringChangeType>> {
        Ok(vec![])
    }
    async fn delete_change_type(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_change(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::EngineeringChange>> {
        Ok(None)
    }
    async fn get_change_by_number(
        ...
        _org_id: Uuid,
        _number: &str,
    ) -> AtlasResult<Option<atlas_shared::EngineeringChange>> {
        Ok(None)
    }
    async fn list_changes(
        ...
        _assigned_to: Option<&Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::EngineeringChange>> {
        Ok(vec![])
    }
    ...
    async fn delete_change(&self, _org_id: Uuid, _number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_change_line(
        ...
        Ok(atlas_shared::EngineeringChangeLine {
            ...
            line_number,
            item_id,
            item_number: item_number.map(String::from),
            ...
            old_revision: old_revision.map(String::from),
            new_revision: new_revision.map(String::from),
            component_item_id,
            component_item_number: component_item_number.map(String::from),
            bom_quantity_old,
            bom_quantity_new,
            effectivity_date,
            effectivity_end_date,
            status: status.to_string(),
            completion_notes: completion_notes.map(String::from),
            sequence_number,
            metadata: serde_json::json!({}),
            created_by,
            created_at: chrono::Utc::now(),
    ...
    async fn get_change_line(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EngineeringChangeLine>> {
        Ok(None)
    }
    async fn list_change_lines(
        &self,
        _change_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::EngineeringChangeLine>> {
        Ok(vec![])
    }
    async fn update_change_line_status(
        ...
        _id: Uuid,
        _status: &str,
        _completion_notes: Option<&str>,
    ) -> AtlasResult<atlas_shared::EngineeringChangeLine> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn delete_change_line(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_affected_item(
        ...
        old_item_status: Option<&str>,
        new_item_status: Option<&str>,
    ...
    async fn get_affected_item(
        &self,
        _change_id: Uuid,
        _item_id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EngineeringChangeAffectedItem>> {
        Ok(None)
    }
    async fn get_affected_item_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::EngineeringChangeAffectedItem>> {
        Ok(None)
    }
    async fn list_affected_items(
        &self,
        _change_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::EngineeringChangeAffectedItem>> {
        Ok(vec![])
    }
    async fn remove_affected_item(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_approval(
        ...
        Ok(atlas_shared::EngineeringChangeApproval {
            ...
            approval_level,
            approver_id,
            approver_name: approver_name.map(String::from),
            approver_role: approver_role.map(String::from),
            status: status.to_string(),
            action_date,
            comments: comments.map(String::from),
            delegated_from_id,
            approval_conditions: approval_conditions.map(String::from),
            metadata: serde_json::json!({}),
            created_by,
            created_at: chrono::Utc::now(),
            updated_at: chrono::Utc::now(),
    ...
    async fn list_approvals(
        &self,
        _change_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::EngineeringChangeApproval>> {
        Ok(vec![])
    }
    ...
    async fn get_dashboard(&self, _org_id: Uuid) -> AtlasResult<atlas_shared::EcmDashboard> {
        Ok(atlas_shared::EcmDashboard {
            ...
            medium_open: 0,
            low_open: 0,
            avg_days_to_implement: 0.0,
            avg_days_to_approve: 0.0,
...
impl crate::channel_revenue::ChannelRevenueRepository for MockChannelRevenueRepository {
    async fn create_promotion(
        ...
        Ok(atlas_shared::TradePromotion {
            ...
            category: category.map(String::from),
            partner_id,
            partner_number: partner_number.map(String::from),
            partner_name: partner_name.map(String::from),
            fund_id,
            start_date,
            end_date,
            ...
            product_id,
            product_number: product_number.map(String::from),
            product_name: product_name.map(String::from),
            ...
            volume_uom: volume_uom.map(String::from),
            tier_config,
            objectives: objectives.map(String::from),
    ...
    async fn get_promotion(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::TradePromotion>> {
        Ok(None)
    }
    async fn get_promotion_by_number(
        &self,
        _org_id: Uuid,
        _promotion_number: &str,
    ) -> AtlasResult<Option<atlas_shared::TradePromotion>> {
        Ok(None)
    }
    async fn list_promotions(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _promotion_type: Option<&str>,
        _partner_id: Option<&Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::TradePromotion>> {
        Ok(vec![])
    }
    ...
    async fn delete_promotion(&self, _org_id: Uuid, _promotion_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_promotion_line(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::TradePromotionLine>> {
        Ok(None)
    }
    async fn list_promotion_lines(
        &self,
        _promotion_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::TradePromotionLine>> {
        Ok(vec![])
    }
    async fn update_promotion_line_actuals(
        &self,
        _id: Uuid,
        _actual_quantity: f64,
        _actual_amount: f64,
        _accrual_amount: f64,
    ) -> AtlasResult<atlas_shared::TradePromotionLine> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn delete_promotion_line(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_fund(
        ...
        Ok(atlas_shared::PromotionFund {
            id: Uuid::new_v4(),
            organization_id: org_id,
            fund_number: fund_number.to_string(),
            name: name.to_string(),
            description: description.map(String::from),
            ...
            currency_code: currency_code.to_string(),
            fund_year,
            fund_quarter: fund_quarter.map(String::from),
            start_date,
            end_date,
            owner_id,
            owner_name: owner_name.map(String::from),
    ...
    async fn get_fund(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::PromotionFund>> {
        Ok(None)
    }
    async fn get_fund_by_number(
        ...
        _org_id: Uuid,
        _fund_number: &str,
    ) -> AtlasResult<Option<atlas_shared::PromotionFund>> {
        Ok(None)
    }
    async fn list_funds(
        &self,
        _org_id: Uuid,
        _status: Option<&str>,
        _fund_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::PromotionFund>> {
        Ok(vec![])
    }
    async fn update_fund_status(
        &self,
        _id: Uuid,
        _status: &str,
    ) -> AtlasResult<atlas_shared::PromotionFund> {
    ...
    async fn update_fund_utilization(
        &self,
        _id: Uuid,
        _allocated_amount: f64,
        _committed_amount: f64,
        _utilized_amount: f64,
        _available_amount: f64,
    ) -> AtlasResult<atlas_shared::PromotionFund> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn delete_fund(&self, _org_id: Uuid, _fund_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_claim(
        ...
        Ok(atlas_shared::TradeClaim {
            ...
            promotion_id,
            promotion_number: promotion_number.map(String::from),
            fund_id,
            fund_number: fund_number.map(String::from),
    ...
    async fn get_claim(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::TradeClaim>> {
        Ok(None)
    }
    async fn get_claim_by_number(
        ...
        _org_id: Uuid,
        _claim_number: &str,
    ) -> AtlasResult<Option<atlas_shared::TradeClaim>> {
        Ok(None)
    }
    async fn list_claims(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _claim_type: Option<&str>,
        _promotion_id: Option<&Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::TradeClaim>> {
        Ok(vec![])
    }
    ...
    async fn delete_claim(&self, _org_id: Uuid, _claim_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_settlement(
        ...
        Ok(atlas_shared::TradeSettlement {
            ...
            settlement_number: settlement_number.to_string(),
            claim_id,
            claim_number: claim_number.map(String::from),
            promotion_id,
            promotion_number: promotion_number.map(String::from),
            partner_id,
            partner_number: partner_number.map(String::from),
    ...
    async fn get_settlement(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::TradeSettlement>> {
        Ok(None)
    }
    ...
    async fn list_settlements(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _settlement_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::TradeSettlement>> {
        Ok(vec![])
    }
    async fn update_settlement_status(
        &self,
    ...
    async fn delete_settlement(&self, _org_id: Uuid, _settlement_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_dashboard(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::ChannelRevenueDashboard> {
        Ok(atlas_shared::ChannelRevenueDashboard {
            ...
            total_funds: 0,
            active_funds: 0,
            total_fund_budget: 0.0,
            total_fund_utilized: 0.0,
...
#[async_trait]
impl crate::product_configurator::ProductConfiguratorRepository
    for MockProductConfiguratorRepository
{
    // Models
    ...
    async fn get_model(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ConfigModel>> {
        Ok(None)
    }
    async fn get_model_by_number(
        ...
        _org_id: Uuid,
        _model_number: &str,
    ) -> AtlasResult<Option<atlas_shared::ConfigModel>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::ConfigModel>> {
        Ok(vec![])
    }
    ...
    async fn delete_model(&self, _org_id: Uuid, _model_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_feature(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ConfigFeature>> {
        Ok(None)
    }
    async fn list_features(
        &self,
        _model_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ConfigFeature>> {
        Ok(vec![])
    }
    async fn delete_feature(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_option(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ConfigOption>> {
        Ok(None)
    }
    async fn list_options(
        &self,
        _feature_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ConfigOption>> {
        Ok(vec![])
    }
    ...
    async fn delete_option(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_rule(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ConfigRule>> {
        Ok(None)
    }
    async fn get_rule_by_code(
        ...
        _model_id: Uuid,
        _rule_code: &str,
    ) -> AtlasResult<Option<atlas_shared::ConfigRule>> {
        Ok(None)
    }
    async fn list_rules(
        &self,
    ...
    ) -> AtlasResult<Vec<atlas_shared::ConfigRule>> {
        Ok(vec![])
    }
    async fn update_rule_active(
        &self,
        _id: Uuid,
        _is_active: bool,
    ) -> AtlasResult<atlas_shared::ConfigRule> {
    ...
    async fn delete_rule(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_instance(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::ConfigInstance>> {
        Ok(None)
    }
    async fn get_instance_by_number(
        &self,
        _org_id: Uuid,
        _instance_number: &str,
    ) -> AtlasResult<Option<atlas_shared::ConfigInstance>> {
        Ok(None)
    }
    ...
    ) -> AtlasResult<Vec<atlas_shared::ConfigInstance>> {
        Ok(vec![])
    }
    ...
    async fn update_instance_validation(
        ...
        _id: Uuid,
        _validation_errors: serde_json::Value,
        _validation_warnings: serde_json::Value,
    ) -> AtlasResult<atlas_shared::ConfigInstance> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn link_instance_to_order(
        &self,
        _id: Uuid,
        _sales_order_id: Option<Uuid>,
        _sales_order_number: Option<&str>,
        _sales_order_line: Option<i32>,
    ) -> AtlasResult<atlas_shared::ConfigInstance> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn delete_instance(&self, _org_id: Uuid, _instance_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_dashboard(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::ConfiguratorDashboard> {
        Ok(atlas_shared::ConfiguratorDashboard {
            ...
            ordered_configurations: 0,
            total_rules: 0,
            active_rules: 0,
            avg_configuration_price: 0.0,
            total_configured_value: 0.0,
...
#[async_trait]
impl crate::transportation_management::TransportationManagementRepository
    for MockTransportationManagementRepository
{
    // Carriers
    ...
    async fn get_carrier(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::Carrier>> {
        Ok(None)
    }
    async fn get_carrier_by_code(
        ...
        _org_id: Uuid,
        _carrier_code: &str,
    ) -> AtlasResult<Option<atlas_shared::Carrier>> {
        Ok(None)
    }
    async fn list_carriers(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _carrier_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::Carrier>> {
        Ok(vec![])
    }
    async fn update_carrier_status(
        &self,
        _id: Uuid,
        _status: &str,
    ) -> AtlasResult<atlas_shared::Carrier> {
    ...
    async fn update_carrier_performance(
        &self,
        _id: Uuid,
        _rating: f64,
        _on_time_pct: f64,
    ...
    async fn delete_carrier(&self, _org_id: Uuid, _carrier_code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_carrier_service(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::CarrierService>> {
        Ok(None)
    }
    async fn list_carrier_services(
        &self,
        _carrier_id: Uuid,
        _active_only: bool,
    ) -> AtlasResult<Vec<atlas_shared::CarrierService>> {
        Ok(vec![])
    }
    async fn update_carrier_service_active(
        &self,
        _id: Uuid,
        _is_active: bool,
    ) -> AtlasResult<atlas_shared::CarrierService> {
    ...
    async fn delete_carrier_service(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_lane(
        ...
        Ok(atlas_shared::TransportLane {
            ...
            description: description.map(std::string::ToString::to_string),
            origin_location_id,
            origin_location_name: origin_location_name.map(std::string::ToString::to_string),
            origin_city: origin_city.map(std::string::ToString::to_string),
            origin_state: origin_state.map(std::string::ToString::to_string),
            origin_country: origin_country.to_string(),
            origin_postal_code: origin_postal_code.map(std::string::ToString::to_string),
            destination_location_id,
            destination_location_name: destination_location_name
                .map(std::string::ToString::to_string),
            destination_city: destination_city.map(std::string::ToString::to_string),
            destination_state: destination_state.map(std::string::ToString::to_string),
            destination_country: destination_country.to_string(),
            destination_postal_code: destination_postal_code.map(std::string::ToString::to_string),
            distance_km,
    ...
    async fn get_lane(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::TransportLane>> {
        Ok(None)
    }
    async fn get_lane_by_code(
        &self,
        _org_id: Uuid,
        _lane_code: &str,
    ) -> AtlasResult<Option<atlas_shared::TransportLane>> {
        Ok(None)
    }
    async fn list_lanes(
        &self,
        _org_id: Uuid,
        _status: Option<&str>,
        _lane_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::TransportLane>> {
        Ok(vec![])
    }
    async fn update_lane_status(
        &self,
        _id: Uuid,
        _status: &str,
    ) -> AtlasResult<atlas_shared::TransportLane> {
    ...
    async fn delete_lane(&self, _org_id: Uuid, _lane_code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_shipment(
        ...
        carrier_service_code: Option<&str>,
        lane_id: Option<Uuid>,
        lane_code: Option<&str>,
        origin_location_id: Option<Uuid>,
        origin_location_name: Option<&str>,
        ...
        temperature_requirements: Option<serde_json::Value>,
        hazmat_info: Option<serde_json::Value>,
        metadata: serde_json::Value,
        created_by: Option<Uuid>,
        ...
        Ok(atlas_shared::TransportShipment {
            ...
            priority: priority.to_string(),
            carrier_id,
            carrier_code: carrier_code.map(std::string::ToString::to_string),
            carrier_name: carrier_name.map(std::string::ToString::to_string),
            carrier_service_id,
            carrier_service_code: carrier_service_code.map(std::string::ToString::to_string),
            lane_id,
            lane_code: lane_code.map(std::string::ToString::to_string),
            origin_location_id,
            origin_location_name: origin_location_name.map(std::string::ToString::to_string),
            origin_address,
            destination_location_id,
            ...
            sales_order_id,
            sales_order_number: sales_order_number.map(std::string::ToString::to_string),
            purchase_order_id,
            purchase_order_number: purchase_order_number.map(std::string::ToString::to_string),
            transfer_order_id,
    ...
    async fn get_shipment(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::TransportShipment>> {
        Ok(None)
    }
    ...
    async fn list_shipments(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _shipment_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::TransportShipment>> {
        Ok(vec![])
    }
    ...
    async fn update_shipment_carrier(
        ...
        _carrier_code: Option<&str>,
        _carrier_name: Option<&str>,
        _carrier_service_id: Option<Uuid>,
        _carrier_service_code: Option<&str>,
    ) -> AtlasResult<atlas_shared::TransportShipment> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn update_shipment_dates(
        &self,
        _id: Uuid,
        _actual_ship_date: Option<chrono::NaiveDate>,
        _actual_delivery_date: Option<chrono::NaiveDate>,
    ) -> AtlasResult<atlas_shared::TransportShipment> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn update_shipment_tracking(
        ...
        _pro_number: Option<&str>,
        _bill_of_lading: Option<&str>,
    ) -> AtlasResult<atlas_shared::TransportShipment> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn update_shipment_totals(
        &self,
        _id: Uuid,
        _weight: f64,
        _volume: f64,
    ...
    async fn update_shipment_delivery(
        &self,
        _id: Uuid,
        _received_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::TransportShipment> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn delete_shipment(&self, _org_id: Uuid, _shipment_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_stop(
        ...
        Ok(atlas_shared::TransportShipmentStop {
            ...
            location_id,
            location_name: location_name.map(std::string::ToString::to_string),
            address,
            planned_arrival,
            actual_arrival: None,
            planned_departure,
    ...
    async fn get_stop(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::TransportShipmentStop>> {
        Ok(None)
    }
    async fn list_stops(
        &self,
        _shipment_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::TransportShipmentStop>> {
        Ok(vec![])
    }
    async fn update_stop_status(
        ...
        _id: Uuid,
        _status: &str,
        _actual_arrival: Option<chrono::DateTime<chrono::Utc>>,
        _actual_departure: Option<chrono::DateTime<chrono::Utc>>,
    ) -> AtlasResult<atlas_shared::TransportShipmentStop> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn delete_stop(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_shipment_line(
        ...
        nmfc_code: Option<&str>,
        hazmat_class: Option<&str>,
        metadata: serde_json::Value,
        ...
        Ok(atlas_shared::TransportShipmentLine {
            ...
            weight_kg,
            volume_cbm,
            lot_number: lot_number.map(std::string::ToString::to_string),
            serial_numbers,
            source_line_id,
            source_line_type: source_line_type.map(std::string::ToString::to_string),
            stop_id,
            freight_class: freight_class.map(std::string::ToString::to_string),
            nmfc_code: nmfc_code.map(std::string::ToString::to_string),
            hazmat_class: hazmat_class.map(std::string::ToString::to_string),
            metadata,
            created_at: chrono::Utc::now(),
            updated_at: chrono::Utc::now(),
        })
    }
    async fn get_shipment_line(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::TransportShipmentLine>> {
        Ok(None)
    }
    async fn list_shipment_lines(
        &self,
        _shipment_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::TransportShipmentLine>> {
        Ok(vec![])
    }
    async fn update_shipment_line_quantities(
        &self,
        _id: Uuid,
        _shipped: i32,
        _received: i32,
    ...
    async fn delete_shipment_line(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn list_tracking_events(
        &self,
        _shipment_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::TransportShipmentTrackingEvent>> {
        Ok(vec![])
    }
    ...
    async fn create_freight_rate(
        ...
        currency_code: &str,
        fuel_surcharge_pct: f64,
        accessorial_rates: serde_json::Value,
        effective_from: chrono::NaiveDate,
        effective_to: Option<chrono::NaiveDate>,
        status: &str,
    ...
    async fn get_freight_rate(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::FreightRate>> {
        Ok(None)
    }
    async fn get_freight_rate_by_code(
        &self,
        _org_id: Uuid,
        _rate_code: &str,
    ) -> AtlasResult<Option<atlas_shared::FreightRate>> {
        Ok(None)
    }
    async fn list_freight_rates(
        &self,
        _org_id: Uuid,
        _carrier_id: Option<&Uuid>,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::FreightRate>> {
        Ok(vec![])
    }
    async fn update_freight_rate_status(
        &self,
        _id: Uuid,
        _status: &str,
    ) -> AtlasResult<atlas_shared::FreightRate> {
    ...
    async fn delete_freight_rate(&self, _org_id: Uuid, _rate_code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_dashboard(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::TransportationDashboard> {
...
impl crate::health_safety::HealthSafetyRepository for MockHealthSafetyRepository {
    ...
    async fn create_incident(
        ...
        Ok(atlas_shared::SafetyIncident {
            ...
            priority: priority.to_string(),
            incident_date,
            incident_time: incident_time.map(String::from),
            location: location.map(String::from),
            facility_id,
            department_id,
            reported_by_id,
            reported_by_name: reported_by_name.map(String::from),
            assigned_to_id,
            assigned_to_name: assigned_to_name.map(String::from),
            root_cause: root_cause.map(String::from),
            immediate_action: immediate_action.map(String::from),
            osha_recordable,
            osha_classification: osha_classification.map(String::from),
            days_away_from_work,
            days_restricted,
    ...
    async fn get_incident(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::SafetyIncident>> {
        Ok(None)
    }
    async fn get_incident_by_number(
        ...
        _org_id: Uuid,
        _number: &str,
    ) -> AtlasResult<Option<atlas_shared::SafetyIncident>> {
        Ok(None)
    }
    async fn list_incidents(
        ...
        _incident_type: Option<&str>,
        _facility_id: Option<&Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::SafetyIncident>> {
        Ok(vec![])
    }
    async fn update_incident_status(
        ...
        Ok(atlas_shared::SafetyIncident {
            id: _id,
            organization_id: Uuid::new_v4(),
            incident_number: "MOCK".to_string(),
            title: "Mock".to_string(),
            description: None,
            incident_type: "injury".to_string(),
    ...
    async fn update_incident_investigation(
        ...
        _immediate_action: Option<&str>,
        _assigned_to_id: Option<Uuid>,
        _assigned_to_name: Option<&str>,
        _days_away: Option<i32>,
        _days_restricted: Option<i32>,
    ) -> AtlasResult<atlas_shared::SafetyIncident> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn close_incident(
        &self,
        _id: Uuid,
        _closed_by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::SafetyIncident> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn delete_incident(&self, _org_id: Uuid, _number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_hazard(
        ...
        Ok(atlas_shared::Hazard {
            ...
            department_id,
            identified_by_id,
            identified_by_name: identified_by_name.map(String::from),
            identified_date,
            mitigation_measures,
    ...
    async fn get_hazard(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::Hazard>> {
        Ok(None)
    }
    async fn get_hazard_by_code(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::Hazard>> {
        Ok(None)
    }
    async fn list_hazards(
        ...
        _status: Option<&str>,
        _risk_level: Option<&str>,
        _hazard_category: Option<&str>,
        _facility_id: Option<&Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::Hazard>> {
        Ok(vec![])
    }
    ...
    async fn update_residual_risk(
        &self,
        _id: Uuid,
        _residual_risk_level: &str,
        _residual_risk_score: i32,
    ) -> AtlasResult<atlas_shared::Hazard> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    async fn delete_hazard(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_inspection(
        ...
        _completed_date: Option<chrono::NaiveDate>,
        location: Option<&str>,
        facility_id: Option<Uuid>,
        department_id: Option<Uuid>,
        ...
        Ok(atlas_shared::SafetyInspection {
            ...
            department_id,
            inspector_id,
            inspector_name: inspector_name.map(String::from),
    ...
    async fn get_inspection(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SafetyInspection>> {
        Ok(None)
    }
    ...
    async fn list_inspections(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _inspection_type: Option<&str>,
        _facility_id: Option<&Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::SafetyInspection>> {
        Ok(vec![])
    }
    async fn complete_inspection(
        &self,
        _id: Uuid,
        _findings_summary: Option<&str>,
        _total: i32,
        _critical: i32,
        _nc: i32,
        _obs: i32,
        _score: Option<f64>,
        _max_score: Option<f64>,
        _score_pct: Option<f64>,
    ...
    async fn delete_inspection(&self, _org_id: Uuid, _number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_corrective_action(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::SafetyCorrectiveAction>> {
        Ok(None)
    }
    ...
    async fn list_corrective_actions(
        ...
        _source_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::SafetyCorrectiveAction>> {
        Ok(vec![])
    }
    ...
    async fn delete_corrective_action(&self, _org_id: Uuid, _number: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn get_dashboard(
        &self,
        org_id: Uuid,
    ) -> AtlasResult<atlas_shared::HealthSafetyDashboard> {
...
impl crate::funds_reservation::FundsReservationRepository for MockFundsReservationRepository {
    async fn create_reservation(
        ...
        let fr = atlas_shared::FundReservation {
            ...
            department_name: department_name.map(String::from),
            fund_check_passed,
            fund_check_message: fund_check_message.map(String::from),
            metadata,
            created_by,
            approved_by: None,
            cancelled_by: None,
        ...
        FR_STORE.with(|s| {
            s.borrow_mut()
                .insert(reservation_number.to_string(), fr.clone())
        });
        Ok(fr)
    }
    ...
    async fn get_reservation(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::FundReservation>> {
    ...
    ) -> AtlasResult<Vec<atlas_shared::FundReservationLine>> {
        Ok(vec![])
    }
    ...
    async fn update_reservation_line_amounts(
        &self,
        _id: Uuid,
        _consumed_amount: f64,
        _released_amount: f64,
        _remaining_amount: f64,
    ) -> AtlasResult<atlas_shared::FundReservationLine> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    }
    ...
    async fn get_dashboard(
        &self,
        org_id: Uuid,
    ) -> AtlasResult<atlas_shared::BudgetaryControlDashboard> {
...
impl crate::rebate_management::RebateManagementRepository for MockRebateManagementRepository {
    ...
    async fn get_agreement(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::RebateAgreement>> {
        Ok(None)
    }
    async fn get_agreement_by_number(
        &self,
        _org_id: Uuid,
        _agreement_number: &str,
    ) -> AtlasResult<Option<atlas_shared::RebateAgreement>> {
        Ok(None)
    }
    async fn list_agreements(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _rebate_type: Option<&str>,
        _partner_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::RebateAgreement>> {
        Ok(vec![])
    }
    ...
    async fn delete_agreement(&self, _org_id: Uuid, _agreement_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_tier(
        ...
        rate_type: &str,
        description: Option<&str>,
    ) -> AtlasResult<atlas_shared::RebateTier> {
    ...
    async fn list_tiers(&self, _agreement_id: Uuid) -> AtlasResult<Vec<atlas_shared::RebateTier>> {
        Ok(vec![])
    }
    async fn delete_tier(&self, _id: Uuid) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_transaction(
        &self,
        ...
        Ok(atlas_shared::RebateTransaction {
            ...
            source_id,
            source_number: source_number.unwrap_or("").to_string(),
            transaction_date,
            product_id,
            product_name: product_name.unwrap_or("").to_string(),
            quantity,
    ...
    async fn get_transaction(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::RebateTransaction>> {
        Ok(None)
    }
    ...
    async fn list_transactions(
        ...
        _agreement_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::RebateTransaction>> {
        Ok(vec![])
    }
    async fn update_transaction_status(
        &self,
    ...
    async fn create_accrual(
        ...
        Ok(atlas_shared::RebateAccrual {
            ...
            organization_id: org_id,
            agreement_id,
            accrual_number: accrual_number.to_string(),
            accrual_date,
    ...
    async fn get_accrual(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::RebateAccrual>> {
        Ok(None)
    }
    async fn get_accrual_by_number(
        ...
        _org_id: Uuid,
        _accrual_number: &str,
    ) -> AtlasResult<Option<atlas_shared::RebateAccrual>> {
        Ok(None)
    }
    async fn list_accruals(
        ...
        _agreement_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::RebateAccrual>> {
        Ok(vec![])
    }
    async fn update_accrual_status(
        &self,
        id: Uuid,
        _status: &str,
    ) -> AtlasResult<atlas_shared::RebateAccrual> {
        Err(AtlasError::EntityNotFound(format!(
            "Accrual {id} not found"
        )))
    }
    async fn delete_accrual(&self, _org_id: Uuid, _accrual_number: &str) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_settlement(
        &self,
    ...
    async fn get_settlement(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::RebateSettlement>> {
        Ok(None)
    }
    async fn get_settlement_by_number(
        &self,
    ...
    async fn list_settlements(
        ...
        _agreement_id: Uuid,
        _status: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::RebateSettlement>> {
        Ok(vec![])
    }
    async fn update_settlement_status(
        &self,
    ...
    async fn create_settlement_line(
        ...
        transaction_id: Uuid,
        amount: f64,
    ) -> AtlasResult<atlas_shared::RebateSettlementLine> {
    ...
    async fn list_settlement_lines(
        &self,
        _settlement_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::RebateSettlementLine>> {
        Ok(vec![])
    }
    async fn get_dashboard(&self, org_id: Uuid) -> AtlasResult<atlas_shared::RebateDashboard> {
        Ok(atlas_shared::RebateDashboard {
            ...
            total_qualifying_amount: 0.0,
            total_accrued_amount: 0.0,
            total_settled_amount: 0.0,
            pending_settlements: 0,
            agreements_by_type: serde_json::json!({}),
...
impl crate::asset_depreciation::AssetDepreciationRepository for MockAssetDepreciationRepository {
    ...
    async fn update_asset_depreciation(
        ...
        _last_depreciation_amount: &str,
        _periods_depreciated: i32,
        _last_depreciation_date: chrono::NaiveDate,
    ) -> AtlasResult<()> {
        Ok(())
    }
}
...
impl crate::deferred_revenue::DeferredRevenueRepository for MockDeferredRevenueRepository {
    async fn create_template(
        ...
        Ok(atlas_shared::DeferralTemplate {
            ...
            name: name.to_string(),
            description: description.map(String::from),
            deferral_type: deferral_type.to_string(),
            recognition_method: recognition_method.to_string(),
            ...
            start_date_basis: start_date_basis.to_string(),
            end_date_basis: end_date_basis.to_string(),
    ...
    async fn get_template(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::DeferralTemplate>> {
        Ok(None)
    }
    ...
    async fn list_templates(
        &self,
        _org_id: Uuid,
        _deferral_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::DeferralTemplate>> {
        Ok(vec![])
    }
    async fn delete_template(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_schedule(
        ...
        Ok(atlas_shared::DeferralSchedule {
            ...
            template_id,
            template_code: template_code.map(String::from),
            deferral_type: deferral_type.to_string(),
            source_type: source_type.to_string(),
            source_id,
            source_number: source_number.map(String::from),
            ...
            description: description.map(String::from),
            total_amount: total_amount.to_string(),
            recognized_amount: recognized_amount.to_string(),
    ...
    async fn get_schedule(&self, _id: Uuid) -> AtlasResult<Option<atlas_shared::DeferralSchedule>> {
        Ok(None)
    }
    async fn get_schedule_by_number(
        ...
        _org_id: Uuid,
        _number: &str,
    ) -> AtlasResult<Option<atlas_shared::DeferralSchedule>> {
        Ok(None)
    }
    async fn list_schedules(
        ...
        _deferral_type: Option<&str>,
        _source_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::DeferralSchedule>> {
        Ok(vec![])
    }
    ...
    async fn create_schedule_line(
        ...
        Ok(atlas_shared::DeferralScheduleLine {
            ...
            days_in_period,
            amount: amount.to_string(),
            recognized_amount: "0.00".to_string(),
            status: status.to_string(),
    ...
    async fn list_schedule_lines(
        &self,
        _schedule_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::DeferralScheduleLine>> {
        Ok(vec![])
    }
    ...
    async fn get_dashboard_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::DeferralDashboardSummary> {
        Ok(atlas_shared::DeferralDashboardSummary {
            total_schedules: 0,
            active_schedules: 0,
            completed_schedules: 0,
            on_hold_schedules: 0,
            total_deferred_amount: "0.00".to_string(),
            total_recognized_amount: "0.00".to_string(),
            total_remaining_amount: "0.00".to_string(),
            pending_recognition_count: 0,
            pending_recognition_amount: "0.00".to_string(),
            revenue_deferred: "0.00".to_string(),
...
impl crate::accounting_hub::AccountingHubRepository for MockAccountingHubRepository {
    ...
    async fn get_external_system(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::ExternalSystem>> {
        Ok(None)
    }
    async fn get_external_system_by_id(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::ExternalSystem>> {
        Ok(None)
    }
    async fn list_external_systems(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<Vec<atlas_shared::ExternalSystem>> {
        Ok(vec![])
    }
    async fn delete_external_system(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    ...
    async fn create_accounting_event(
        ...
        Ok(atlas_shared::AccountingEvent {
            ...
            accounting_date,
            currency_code: currency_code.to_string(),
            total_amount: total_amount.map(String::from),
            description: description.map(String::from),
            processed_by: None,
            processed_at: None,
            metadata: serde_json::json!({}),
    ...
    async fn get_accounting_event(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::AccountingEvent>> {
        Ok(None)
    }
    ...
    async fn list_accounting_events(
        ...
        _org_id: Uuid,
        _status: Option<&str>,
        _system_id: Option<Uuid>,
        _event_type: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::AccountingEvent>> {
        Ok(vec![])
    }
    async fn update_event_status(
        ...
        _status: &str,
        _error: Option<&str>,
        _attrs: Option<serde_json::Value>,
        _je: Option<Uuid>,
        _by: Option<Uuid>,
    ) -> AtlasResult<atlas_shared::AccountingEvent> {
        Err(AtlasError::EntityNotFound("Mock".to_string()))
    ...
    async fn get_mapping_rule(
        ...
        _system_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::TransactionMappingRule>> {
        Ok(None)
    }
    async fn list_mapping_rules(
        ...
        _org_id: Uuid,
        _system_id: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::TransactionMappingRule>> {
        Ok(vec![])
    }
    ...
    async fn delete_mapping_rule(&self, _org_id: Uuid, _code: &str) -> AtlasResult<()> {
        Ok(())
    }
    async fn get_dashboard_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::AccountingHubDashboardSummary> {
        Ok(atlas_shared::AccountingHubDashboardSummary {
            ...
            posted_events: 0,
            error_events: 0,
            total_amount_processed: "0.00".to_string(),
            events_by_system: serde_json::json!([]),
...
impl crate::financial_controls::FinancialControlsRepository for MockFinancialControlsRepository {
    async fn create_rule(
        ...
        Ok(atlas_shared::ControlMonitorRule {
            ...
            conditions,
            threshold_value: threshold_value.map(String::from),
            target_entity: target_entity.to_string(),
            target_fields,
            actions,
            auto_resolve,
            check_schedule: check_schedule.to_string(),
            is_active: true,
            effective_from,
            effective_to,
            last_check_at: None,
    ...
    async fn get_rule(
        ...
        _org_id: Uuid,
        _code: &str,
    ) -> AtlasResult<Option<atlas_shared::ControlMonitorRule>> {
        Ok(None)
    }
    ...
    async fn list_rules(
        ...
        _category: Option<&str>,
        _risk_level: Option<&str>,
    ) -> AtlasResult<Vec<atlas_shared::ControlMonitorRule>> {
        Ok(vec![])
    }
    ...
    async fn update_rule_stats(
        ...
        _total: i32,
        _resolved: i32,
        _last: Option<chrono::DateTime<chrono::Utc>>,
    ) -> AtlasResult<()> {
        Ok(())
    }
    async fn create_violation(
        ...
        Ok(atlas_shared::ControlViolation {
            ...
            violation_number: violation_number.to_string(),
    ...
    async fn get_violation(
        &self,
        _id: Uuid,
    ) -> AtlasResult<Option<atlas_shared::ControlViolation>> {
        Ok(None)
    }
    ...
    async fn list_violations(
        ...
        _rule: Option<Uuid>,
        _assigned: Option<Uuid>,
    ) -> AtlasResult<Vec<atlas_shared::ControlViolation>> {
        Ok(vec![])
    }
    async fn update_violation_status(
        &self,
    ...
    async fn get_dashboard_summary(
        &self,
        _org_id: Uuid,
    ) -> AtlasResult<atlas_shared::FinancialControlsDashboardSummary> {
