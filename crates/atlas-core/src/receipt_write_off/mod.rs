...
#[allow(dead_code)]
pub struct PostgresReceiptWriteOffRepository {
    #[allow(dead_code)]
    pool: PgPool,
}
impl PostgresReceiptWriteOffRepository {
    #[must_use]
...
impl ReceiptWriteOffRepository for PostgresReceiptWriteOffRepository {
    ...
    async fn get_reason(&self, _: Uuid, _: &str) -> AtlasResult<Option<WriteOffReason>> {
        Ok(None)
    }
    async fn get_reason_by_id(&self, _: Uuid) -> AtlasResult<Option<WriteOffReason>> {
        Ok(None)
    }
    async fn list_reasons(&self, _: Uuid) -> AtlasResult<Vec<WriteOffReason>> {
        Ok(vec![])
    }
    ...
    async fn get_request(&self, _: Uuid) -> AtlasResult<Option<WriteOffRequest>> {
        Ok(None)
    }
    async fn get_request_by_number(
        &self,
    ...
    async fn get_batch(&self, _: Uuid) -> AtlasResult<Option<WriteOffBatch>> {
        Ok(None)
    }
    async fn list_batches(&self, _: Uuid, _: Option<&str>) -> AtlasResult<Vec<WriteOffBatch>> {
        Ok(vec![])
    }
    async fn update_batch_status(
        &self,
    ...
    async fn list_policies(&self, _: Uuid) -> AtlasResult<Vec<WriteOffPolicy>> {
        Ok(vec![])
    }
    async fn get_active_policy(&self, _: Uuid, _: &str) -> AtlasResult<Option<WriteOffPolicy>> {
        Ok(None)
    }
