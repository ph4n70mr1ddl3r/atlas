...
impl ReceivablesFactoringRepository for PostgresReceivablesFactoringRepository {
    ...
    async fn get_factor_company(&self, _: Uuid) -> AtlasResult<Option<FactorCompany>> {
        Ok(None)
    }
    async fn get_factor_company_by_code(
        &self,
    ...
    async fn deactivate_factor_company(&self, _: Uuid) -> AtlasResult<FactorCompany> {
        Err(AtlasError::EntityNotFound("Not found".into()))
    }
    async fn activate_factor_company(&self, _: Uuid) -> AtlasResult<FactorCompany> {
        Err(AtlasError::EntityNotFound("Not found".into()))
    }
    ...
    async fn get_agreement(&self, _: Uuid) -> AtlasResult<Option<FactoringAgreement>> {
        Ok(None)
    }
    async fn list_agreements(
        &self,
    ...
    async fn get_request(&self, _: Uuid) -> AtlasResult<Option<FactoringRequest>> {
        Ok(None)
    }
    async fn list_requests(
        &self,
    ...
    async fn update_request_status(&self, _: Uuid, _: &str) -> AtlasResult<FactoringRequest> {
        Err(AtlasError::EntityNotFound("Not found".into()))
    }
    async fn update_request_funding(
        &self,
    ...
    async fn list_request_lines(&self, _: Uuid) -> AtlasResult<Vec<FactoringRequestLine>> {
        Ok(vec![])
    }
