...
#[allow(dead_code)]
pub struct PostgresRevenueManagementRepository {
    #[allow(dead_code)]
    pool: PgPool,
}
impl PostgresRevenueManagementRepository {
    #[must_use]
...
impl RevenueManagementRepository for PostgresRevenueManagementRepository {
    ...
    async fn get_contract(&self, _: Uuid, _: &str) -> AtlasResult<Option<RevMgmtContract>> {
        Ok(None)
    }
    async fn get_contract_by_id(&self, _: Uuid) -> AtlasResult<Option<RevMgmtContract>> {
        Ok(None)
    }
    async fn list_contracts(&self, _: Uuid, _: Option<&str>) -> AtlasResult<Vec<RevMgmtContract>> {
        Ok(vec![])
    }
    async fn update_contract_status(&self, _: Uuid, _: &str) -> AtlasResult<RevMgmtContract> {
    ...
    async fn list_obligations_by_contract(&self, _: Uuid) -> AtlasResult<Vec<RevMgmtObligation>> {
        Ok(vec![])
    }
    async fn update_obligation_status(
        &self,
    ...
    async fn list_events_by_contract(&self, _: Uuid) -> AtlasResult<Vec<RevMgmtRecognitionEvent>> {
        Ok(vec![])
    }
    async fn list_events_by_obligation(
        &self,
