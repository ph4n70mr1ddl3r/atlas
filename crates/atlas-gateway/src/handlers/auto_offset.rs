...
pub async fn create_offset_template(
    ...
    match state
        ...
        .create_template(
            ...
            payload.intercompany_segment.as_deref(),
            &payload.generation_method,
            &payload.default_offset_account,
            payload.default_offset_account_description.as_deref(),
...
pub async fn add_offset_template_line(
    ...
    match state
        ...
        .add_template_line(
            ...
            &payload.due_to_account,
            payload.due_to_account_description.as_deref(),
            &payload.due_from_account,
            payload.due_from_account_description.as_deref(),
...
pub async fn generate_offsets(
    ...
    let journal_lines: Vec<atlas_core::auto_offset::JournalLine> = payload
        .journal_lines
        .iter()
...
pub async fn list_offset_lines(
    ...
    match state
        .financials
        .auto_offset_engine
        .list_offset_lines(generation_id)
        .await
    {
        Ok(lines) => Ok(Json(serde_json::json!({ "data": lines }))),
        Err(e) => {
