...
fn default_display_order() -> String {
...
pub async fn create_financial_template(
    ...
    match state
        ...
        .await
    {
        Ok(t) => Ok(Json(serde_json::to_value(t).unwrap_or_else(|e| {
...
pub async fn list_financial_templates(
    ...
    match state
        .shared
        .financial_reporting_engine
        .list_templates(org_id, query.report_type.as_deref())
        .await
    {
...
pub async fn create_financial_row(
    ...
    match state
        ...
        .await
    {
        Ok(row) => Ok(Json(serde_json::to_value(row).unwrap_or_else(|e| {
            tracing::error!("Serialization error: {}", e);
            serde_json::Value::Null
        }))),
        Err(e) => Err(map_error(e)),
...
pub async fn create_financial_column(
    ...
    match state
        ...
        .await
    {
        Ok(col) => Ok(Json(serde_json::to_value(col).unwrap_or_else(|e| {
            tracing::error!("Serialization error: {}", e);
            serde_json::Value::Null
        }))),
        Err(e) => Err(map_error(e)),
...
pub async fn list_financial_runs(
    ...
    match state
        .shared
        .financial_reporting_engine
        .list_runs(org_id, query.template_id, query.status.as_deref())
        .await
    {
...
pub async fn create_financial_income_statement(
    ...
    match state
        .shared
        .financial_reporting_engine
        .create_income_statement_template(
            org_id,
            &body.code,
            &body.name,
            &body.currency_code,
...
pub async fn add_financial_favourite(
    ...
    match state
        .shared
        .financial_reporting_engine
        .add_favourite(org_id, user_id, template_id, None)
        .await
    {
        Ok(fav) => Ok(Json(serde_json::to_value(fav).unwrap_or_else(|e| {
            tracing::error!("Serialization error: {}", e);
            serde_json::Value::Null
        }))),
        Err(e) => Err(map_error(e)),
...
pub async fn list_financial_favourites(
    ...
    match state
        .shared
        .financial_reporting_engine
        .list_favourites(org_id, user_id)
        .await
    {
...
pub async fn remove_financial_favourite(
    ...
    match state
        .shared
        .financial_reporting_engine
        .remove_favourite(org_id, user_id, template_id)
        .await
    {
