...
pub async fn create_program(
    ...
    let program = state
        ...
        .create_program(
            ...
            payload.points_name.as_deref(),
            payload.enrollment_type.as_deref(),
            payload.start_date,
            payload.end_date,
            payload.accrual_rate,
            payload.accrual_basis.as_deref(),
            payload.minimum_accrual_amount,
            payload.rounding_method.as_deref(),
            payload.points_expiry_days,
            payload.tier_qualification_period.as_deref(),
            payload.auto_upgrade,
            payload.auto_downgrade,
            payload.max_points_per_member,
            payload.allow_point_transfer,
            payload.allow_redemption,
...
pub async fn delete_program(
    ...
    state
        .crm
        .loyalty_engine
        .delete_program(org_id, &program_number)
        .await
        .map_err(map_err)?;
...
pub async fn create_tier(
    ...
    let tier = state
        ...
        .create_tier(
            ...
            &payload.tier_code,
            &payload.tier_name,
            payload.tier_level.unwrap_or(0),
            payload.minimum_points.unwrap_or(0.0),
            payload.maximum_points,
            payload.accrual_bonus_percentage,
            payload.benefits.as_deref(),
...
pub async fn list_members(
    ...
    let members = state
        .crm
        .loyalty_engine
        .list_members(program_id, params.status.as_deref())
        .await
        .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
...
pub async fn delete_member(
    ...
    state
        .crm
        .loyalty_engine
        .delete_member(org_id, &member_number)
        .await
        .map_err(map_err)?;
    Ok(StatusCode::NO_CONTENT)
}
...
pub async fn accrue_points(
    ...
    let txn = state
        ...
        .accrue_points(
            ...
            payload.reference_currency.as_deref(),
            payload.description.as_deref(),
            Some(user_id),
        )
        .await
...
pub async fn reverse_transaction(
    ...
    let txn = state
        .crm
        .loyalty_engine
        .reverse_transaction(id, &payload.reason)
        .await
        .map_err(map_err)?;
    Ok(to_json(txn))
}
...
pub async fn list_transactions(
    ...
    let txns = state
        .crm
        .loyalty_engine
        .list_transactions(member_id, params.txn_type.as_deref())
        .await
        .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
...
pub async fn create_reward(
    ...
    let reward = state
        ...
        .create_reward(
            ...
            &payload.name,
            payload.description.as_deref(),
            payload.reward_type.as_deref().unwrap_or("merchandise"),
            payload.points_required,
            payload.cash_value,
            payload.currency_code.as_deref(),
            payload.tier_restriction.as_deref(),
            payload.quantity_available,
            payload.max_per_member,
...
pub async fn list_rewards(
    ...
    let rewards = state
        .crm
        .loyalty_engine
        .list_rewards(program_id, params.reward_type.as_deref())
        .await
        .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
...
pub async fn delete_reward(
    ...
    state
        .crm
        .loyalty_engine
        .delete_reward(org_id, &reward_code)
        .await
        .map_err(map_err)?;
    Ok(StatusCode::NO_CONTENT)
}
...
pub async fn cancel_redemption(
    ...
    let redemption = state
        .crm
        .loyalty_engine
        .cancel_redemption(id, &payload.reason)
        .await
        .map_err(map_err)?;
    Ok(to_json(redemption))
}
...
pub async fn list_redemptions(
    ...
    let redemptions = state
        .crm
        .loyalty_engine
        .list_redemptions(member_id, params.status.as_deref())
        .await
        .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
