...
fn core_api_routes() -> Router<Arc<AppState>> {
    Router::new()
...
fn fusion_api_routes() -> Router<Arc<AppState>> {
    Router::new()
...
fn advanced_api_routes() -> Router<Arc<AppState>> {
    Router::new()
...
fn period_close_api_routes() -> Router<Arc<AppState>> {
    Router::new()
...
fn tax_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Tax Regimes
        .route("/regimes", get(list_tax_regimes))
...
fn intercompany_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Intercompany Batches
        .route("/batches", get(list_intercompany_batches))
...
fn reconciliation_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/rules/:id", delete(delete_matching_rule))
}

fn expense_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Expense Categories
        .route("/categories", get(list_expense_categories))
        ...
        .route("/reports/:id", get(get_expense_report))
        .route("/reports/:id/submit", post(submit_expense_report))
...
fn budget_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Budget Definitions
        .route("/definitions", get(list_budget_definitions))
...
fn fixed_assets_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Asset Categories
        .route("/categories", get(list_asset_categories))
        ...
        .route("/retirements/:id/approve", post(approve_asset_retirement))
}

fn sla_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Accounting Methods
        .route("/methods", get(list_accounting_methods))
...
fn encumbrance_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Encumbrance Types
        .route("/types", get(list_encumbrance_types))
...
fn cash_management_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Cash Positions
        .route("/positions", post(upsert_cash_position))
...
fn sourcing_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Sourcing Events
        .route("/events", post(create_sourcing_event))
        .route("/events", get(list_sourcing_events))
        .route("/events/:id", get(get_sourcing_event))
...
fn lease_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Lease Contracts
        .route("/contracts", get(list_leases))
...
fn project_costing_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Cost Transactions
        .route("/transactions", get(list_cost_transactions))
        .route("/transactions", post(create_cost_transaction))
...
fn cost_allocation_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Allocation Pools
        .route("/pools", get(list_allocation_pools))
        ...
        .route("/runs/:id", get(get_allocation_run))
...
fn financial_reporting_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Report Templates
        .route("/templates", get(list_financial_templates))
...
fn multi_book_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Accounting Books
        .route("/books", get(list_accounting_books))
        .route("/books", post(create_accounting_book))
        ...
        .route("/books/:book_id/entries", get(list_book_journal_entries))
...
fn procurement_contracts_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Contract Types
        ...
        .route("/:id/submit", post(submit_contract))
...
fn inventory_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        .route("/organizations", post(create_inventory_org))
        .route("/organizations", get(list_inventory_orgs))
        .route("/organizations/:code", get(get_inventory_org))
        .route("/organizations/:code", delete(delete_inventory_org))
        .route("/items", post(create_item))
        .route("/items", get(list_items))
        .route("/items/:id", get(get_item))
        .route("/on-hand", get(list_on_hand_balances))
        .route("/transactions/receive", post(receive_item))
        .route("/transactions/issue", post(issue_item))
        .route("/transactions/transfer", post(transfer_item))
...
fn returns_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Return Reasons
        .route("/reasons", post(create_return_reason))
        ...
        .route("/rmas/:id", get(get_rma))
        .route("/rmas/:id/submit", post(submit_rma))
...
fn pricing_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Price Lists
        .route("/price-lists", post(create_price_list))
        .route("/price-lists", get(list_price_lists))
        .route("/price-lists/:code", get(get_price_list))
...
fn commission_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/plans/:code", get(get_commission_plan))
...
fn treasury_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Counterparties
        .route("/counterparties", post(create_counterparty))
...
fn grants_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Sponsors
        ...
        .route("/awards/:id", get(get_grant_award))
        .route("/awards/:id/activate", post(activate_award))
...
fn supplier_qualification_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Qualification Areas
        .route("/areas", post(create_qualification_area))
        ...
        .route("/initiatives/:id", get(get_initiative))
...
fn journals_api_routes() -> Router<Arc<AppState>> {
    Router::new()
        // Journal Batches
        .route("/batches", post(create_journal_batch))
        .route("/batches", get(list_journal_batches))
        .route("/batches/:batch_number", get(get_journal_batch))
        .route("/batches/:batch_number", delete(delete_journal_batch))
        .route("/batches/:id/submit", post(submit_batch))
        .route("/batches/:id/approve", post(approve_journal_batch))
...
pub fn api_routes() -> Router<Arc<AppState>> {
    Router::new()
        .merge(core_api_routes())
        .merge(fusion_api_routes())
        .merge(advanced_api_routes())
        .nest("/period-close", period_close_api_routes())
        .merge(currency_api_routes())
        .nest("/tax", tax_api_routes())
        .nest("/intercompany", intercompany_api_routes())
        .nest("/reconciliation", reconciliation_api_routes())
        .nest("/expense", expense_api_routes())
        .nest("/budget", budget_api_routes())
        .nest("/fixed-assets", fixed_assets_api_routes())
        .nest("/sla", sla_api_routes())
        .nest("/encumbrance", encumbrance_api_routes())
        .nest("/cash-management", cash_management_api_routes())
        .nest("/sourcing", sourcing_api_routes())
        .nest("/lease", lease_api_routes())
        .nest("/project-costing", project_costing_api_routes())
        .nest("/cost-allocation", cost_allocation_api_routes())
        .nest("/financial-reporting", financial_reporting_api_routes())
        .nest("/multi-book", multi_book_api_routes())
        .nest("/procurement-contracts", procurement_contracts_api_routes())
        .nest("/inventory", inventory_api_routes())
        .nest("/returns", returns_api_routes())
        .nest("/pricing", pricing_api_routes())
