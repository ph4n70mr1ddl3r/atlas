...
pub async fn create_requisition(
    ...
    match state
        ...
        .create_requisition(
            ...
            payload.salary_min.as_deref(),
            payload.salary_max.as_deref(),
            payload.currency.as_deref(),
            payload.required_skills.as_ref(),
            payload.qualifications.as_deref(),
            payload.experience_years_min,
            payload.experience_years_max,
            payload.education_level.as_deref(),
            payload.hiring_manager_id,
        ...
        .await
    {
        ...
        Err(e) => {
            error!("Failed to create requisition: {}", e);
            Err(rec_map_err(e))
        }
    }
}
...
pub async fn list_requisitions(
    ...
    match state
        .hcm
        .recruiting_engine
        .list_requisitions(org_id, params.status.as_deref())
        .await
    {
...
pub async fn delete_requisition(
    ...
    match state
        .hcm
        .recruiting_engine
        .delete_requisition(org_id, &number)
        .await
    {
...
pub async fn create_candidate(
    ...
    match state
        ...
        .create_candidate(
            ...
            payload.source_detail.as_deref(),
            payload.resume_url.as_deref(),
            payload.current_employer.as_deref(),
            payload.current_title.as_deref(),
            payload.years_of_experience,
            payload.education_level.as_deref(),
            payload.skills.as_ref(),
...
pub async fn list_candidates(
    ...
    match state
        .hcm
        .recruiting_engine
        .list_candidates(org_id, params.status.as_deref())
        .await
    {
...
pub async fn update_application_status(
    ...
    match state
        .hcm
        .recruiting_engine
        .update_application_status(id, &payload.status, payload.notes.as_deref())
        .await
    {
...
pub async fn create_interview(
    ...
    match state
        ...
        .create_interview(
            ...
            payload.location.as_deref(),
            payload.meeting_link.as_deref(),
            payload.interviewer_ids.as_ref(),
            payload.interviewer_names.as_ref(),
            payload.notes.as_deref(),
            user_id,
        )
        .await
...
pub async fn list_interviews(
    ...
    match state
        .hcm
        .recruiting_engine
        .list_interviews(application_id)
        .await
    {
...
pub async fn create_offer(
    ...
    match state
        ...
        .create_offer(
            org_id,
            application_id,
            payload.offer_number.as_deref(),
            &payload.job_title,
            payload.department.as_deref(),
            payload.location.as_deref(),
            payload.employment_type.as_deref().unwrap_or("full_time"),
            payload.start_date,
            payload.salary_offered.as_deref(),
            payload.salary_currency.as_deref(),
            payload.salary_frequency.as_deref(),
            payload.signing_bonus.as_deref(),
            payload.benefits_summary.as_deref(),
...
pub async fn list_offers(
    ...
    match state
        .hcm
        .recruiting_engine
        .list_offers(org_id, params.status.as_deref())
        .await
    {
...
pub async fn accept_offer(
    ...
    match state
        .hcm
        .recruiting_engine
        .accept_offer(id, payload.notes.as_deref())
        .await
    {
        Ok(o) => Ok(Json(crate::handlers::records::to_json_or_null(o))),
        Err(e) => {
...
pub async fn decline_offer(
    ...
    match state
        .hcm
        .recruiting_engine
        .decline_offer(id, payload.notes.as_deref())
        .await
    {
        Ok(o) => Ok(Json(crate::handlers::records::to_json_or_null(o))),
        Err(e) => {
