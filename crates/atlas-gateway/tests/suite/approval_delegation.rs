    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/approval-delegation/rules/{}/activate",
                    rule_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/approval-delegation/rules/{}/cancel",
                    rule_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    app.clone()
        .oneshot(
            Request::builder()
                ...
                .body(Body::from(
                    serde_json::to_string(&json!({"reason": "first"})).unwrap(),
                ))
                .unwrap(),
        )
        .await
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({"reason": "second"})).unwrap(),
                ))
                .unwrap(),
        )
        .await
