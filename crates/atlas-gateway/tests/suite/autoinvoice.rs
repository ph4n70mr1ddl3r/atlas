...
async fn create_test_validation_rule(
    app: &axum::Router,
    name: &str,
    field_name: &str,
) -> serde_json::Value {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/autoinvoice/validation-rules")
...
async fn import_test_batch(app: &axum::Router, lines: Vec<serde_json::Value>) -> serde_json::Value {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/autoinvoice/batches")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
...
async fn test_create_grouping_rule_duplicate_name() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/autoinvoice/grouping-rules")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(&format!(
                    "/api/v1/autoinvoice/grouping-rules/{}",
                    uuid::Uuid::new_v4()
                ))
                .header(&k, &v)
                .body(Body::empty())
...
async fn test_list_batches_by_status() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri("/api/v1/autoinvoice/batches?status=pending")
                .header(&k, &v)
                .body(Body::empty())
                .unwrap(),
        )
...
async fn test_import_and_process() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/autoinvoice/import-and-process")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("PUT")
                .uri(&format!(
                    "/api/v1/autoinvoice/invoices/{}/status",
                    invoice_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({"status": "posted"})).unwrap(),
                ))
                .unwrap(),
        )
        .await
...
async fn test_autoinvoice_dashboard() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri("/api/v1/autoinvoice/dashboard")
                .header(&k, &v)
                .body(Body::empty())
                .unwrap(),
        )
