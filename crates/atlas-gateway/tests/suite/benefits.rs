...
async fn create_test_enrollment(
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/benefits/enrollments")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/benefits/enrollments/{}/activate",
                    enrollment_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/benefits/enrollments/{}/suspend",
                    enrollment_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/benefits/enrollments/{}/reactivate",
                    enrollment_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/benefits/enrollments/{}/cancel",
                    enrollment_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/benefits/enrollments/{}/waive",
                    enrollment_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(&format!(
                    "/api/v1/benefits/enrollments?employee_id={}",
                    employee_id
                ))
                .header(&k, &v)
                .body(Body::empty())
...
async fn test_enrollment_family_tier_costs() {
    ...
    assert!(
        parsed > 0.0,
        "Expected positive cost for family tier, got {} (raw: {:?})",
        emp_cost_str,
        emp_cost
    );
    assert!(
        (parsed - 450.0).abs() < 1.0,
        "Expected ~450 for family tier, got {}",
        parsed
    );
}
