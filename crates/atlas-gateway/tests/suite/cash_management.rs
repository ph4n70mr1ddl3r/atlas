...
async fn create_test_position(
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/cash-management/positions")
...
async fn create_test_source(
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/cash-management/sources")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
...
async fn test_cash_position_summary() {
    ...
    let total: f64 = summary["total_book_balance"]
        .as_str()
        .unwrap()
        .parse()
        .unwrap();
...
async fn test_generate_cash_forecast() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/cash-management/forecasts")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(&format!(
                    "/api/v1/cash-management/forecasts/{}/lines",
                    forecast_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/cash-management/forecasts/{}/approve",
                    forecast_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
