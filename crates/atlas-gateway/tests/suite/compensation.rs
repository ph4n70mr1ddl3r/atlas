...
async fn create_test_cycle(
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/compensation/cycles")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
    ...
    app.clone()
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/compensation/cycles/{}/transition",
                    cycle_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    app.clone()
        .oneshot(
            Request::builder()
                ...
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({"status": "allocation"})).unwrap(),
                ))
                .unwrap(),
        )
        .await
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({"status": "review"})).unwrap(),
                ))
                .unwrap(),
        )
        .await
...
async fn test_worksheet_full_workflow() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/compensation/cycles/{}/worksheets",
                    cycle_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let change: f64 = line["salaryChangeAmount"]
        .as_str()
        .unwrap()
        .parse()
        .unwrap();
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/compensation/worksheets/{}/approve",
                    ws_id
                ))
                .header(&k, &v)
                .body(Body::empty())
...
async fn test_update_worksheet_line() {
    ...
    let total: f64 = updated["totalCompensation"]
        .as_str()
        .unwrap()
        .parse()
        .unwrap();
...
async fn test_generate_and_publish_statement() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/compensation/cycles/{}/statements",
                    cycle_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let direct: f64 = stmt["totalDirectCompensation"]
        .as_str()
        .unwrap()
        .parse()
        .unwrap();
    assert!((direct - 163000.0).abs() < 1.0);
    let indirect: f64 = stmt["totalIndirectCompensation"]
        .as_str()
        .unwrap()
        .parse()
        .unwrap();
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/compensation/statements/{}/publish",
                    stmt_id
                ))
                .header(&k, &v)
                .body(Body::empty())
