...
async fn create_test_format(app: &axum::Router, code: &str) -> serde_json::Value {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/journal-import/formats")
    ...
    assert_eq!(
        r.status(),
        StatusCode::CREATED,
        "Failed to create import format"
    );
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/journal-import/formats/{}/mappings",
                    format_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
...
async fn test_create_import_batch() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/journal-import/batches")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/journal-import/batches/{}/validate",
                    batch_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/journal-import/batches/{}/import",
                    batch_id
                ))
                .header(&k, &v)
                .body(Body::empty())
