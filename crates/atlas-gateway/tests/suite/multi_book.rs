...
async fn create_account_mapping(
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/multi-book/mappings")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
...
async fn test_create_secondary_book() {
    ...
    let secondary = create_secondary_book(
        &app,
        "IFRS",
        "IFRS Secondary",
        "IFRS_COA",
...
async fn test_create_account_mapping() {
    ...
    let primary = create_primary_book(
        &app,
        "US_GAAP",
        "US GAAP Primary",
        "US_COA",
    ...
    let mapping = create_account_mapping(
        &app,
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/multi-book/entries/{}/reverse",
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(&format!(
                    "/api/v1/multi-book/books/{}/entries?status=propagated",
                    secondary["id"].as_str().unwrap()
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/multi-book/entries/{}/propagate",
                    entry["id"].as_str().unwrap()
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(&format!(
                    "/api/v1/multi-book/entries/{}/lines",
                    entry["id"].as_str().unwrap()
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/multi-book/entries/{}/post",
                    entry["id"].as_str().unwrap()
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
