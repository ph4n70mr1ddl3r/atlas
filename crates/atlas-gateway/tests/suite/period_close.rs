...
async fn generate_test_periods(
    app: &axum::Router,
    k: &str,
    v: &str,
    calendar_id: Uuid,
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(format!(
                    "/api/v1/period-close/calendars/{}/periods/generate",
                    calendar_id
                ))
                .header("Content-Type", "application/json")
                .header(k, v)
...
async fn get_first_period_id(app: &axum::Router, k: &str, v: &str, calendar_id: Uuid) -> Uuid {
    let r = app
        ...
        .oneshot(
            Request::builder()
                .uri(format!(
                    "/api/v1/period-close/calendars/{}/periods?fiscal_year=2026",
                    calendar_id
                ))
                .header(k, v)
                .body(Body::empty())
    ...
    data["data"].as_array().unwrap()[0]["id"]
        .as_str()
        .unwrap()
        .parse()
        .unwrap()
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({"comment": "Opening Jan"})).unwrap(),
                ))
                .unwrap(),
        )
        .await
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(json!({"comment": "Open"}).to_string()))
                .unwrap(),
        )
        .await
        .unwrap();
        ...
        let r = app
            ...
            .oneshot(
                Request::builder()
                    .method("POST")
                    .uri(format!(
                        "/api/v1/period-close/periods/{}/subledger",
                        period_id
                    ))
                    .header("Content-Type", "application/json")
                    .header(&k, &v)
                    .body(Body::from(
                        json!({"subledger": subledger, "status": "closed"}).to_string(),
                    ))
                    .unwrap(),
            )
            .await
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header(&k, &v)
                .body(Body::from(
                    json!({"comment": "Closing Jan", "force": false}).to_string(),
                ))
                .unwrap(),
        )
        .await
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(format!(
                    "/api/v1/period-close/periods/{}/permanently-close",
                    period_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(json!({"comment": "Permanent"}).to_string()))
                .unwrap(),
        )
        .await
        .unwrap();
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header(&k, &v)
                .body(Body::from(
                    json!({"comment": "Try close", "force": false}).to_string(),
                ))
                .unwrap(),
        )
        .await
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                ...
                .header(&k, &v)
                .body(Body::from(
                    json!({"comment": "Force close", "force": true}).to_string(),
                ))
                .unwrap(),
        )
        .await
...
async fn test_posting_allowed_for_open_period() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .uri(format!(
                    "/api/v1/period-close/calendars/{}/check-posting?date=2026-01-15",
                    calendar_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(format!(
                    "/api/v1/period-close/periods/{}/checklist",
                    period_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
...
async fn test_close_summary() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .uri(format!(
                    "/api/v1/period-close/calendars/{}/summary?fiscal_year=2026",
                    calendar_id
                ))
                .header(&k, &v)
                .body(Body::empty())
