...
async fn test_delete_carrier() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("DELETE")
                .uri("/api/v1/shipping/carriers-by-code/DELC")
                .header(&k, &v)
                .body(Body::empty())
                .unwrap(),
        )
...
async fn test_list_shipments() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri("/api/v1/shipping/shipments?status=draft")
                .header(&k, &v)
                .body(Body::empty())
                .unwrap(),
        )
    ...
    app.clone()
        .oneshot(
            Request::builder()
                ...
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({"tracking_number": "T123"})).unwrap(),
                ))
                .unwrap(),
        )
        .await
