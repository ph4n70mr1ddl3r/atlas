...
async fn setup_subscription_test() -> (std::sync::Arc<atlas_gateway::AppState>, axum::Router) {
    ...
    sqlx::query("DELETE FROM _atlas.subscription_revenue_schedule")
        .execute(&state.db_pool)
        .await
        .ok();
    sqlx::query("DELETE FROM _atlas.subscription_billing_schedule")
        .execute(&state.db_pool)
        .await
        .ok();
    sqlx::query("DELETE FROM _atlas.subscription_amendments")
        .execute(&state.db_pool)
        .await
        .ok();
    sqlx::query("DELETE FROM _atlas.subscriptions")
        .execute(&state.db_pool)
        .await
        .ok();
    sqlx::query("DELETE FROM _atlas.subscription_price_tiers")
        .execute(&state.db_pool)
        .await
        .ok();
    sqlx::query("DELETE FROM _atlas.subscription_products")
        .execute(&state.db_pool)
        .await
        .ok();
...
async fn create_test_product(app: &axum::Router, code: &str) -> serde_json::Value {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/subscription/products")
...
async fn create_test_subscription(app: &axum::Router, product_id: &str) -> serde_json::Value {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/subscription/subscriptions")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/subscription/subscriptions/{}/activate",
                    id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/subscription/subscriptions/{}/suspend",
                    id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/subscription/subscriptions/{}/reactivate",
                    id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/subscription/subscriptions/{}/amendments",
                    id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/subscription/amendments/{}/apply",
                    amendment_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/subscription/amendments/{}/cancel",
                    amendment_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(&format!(
                    "/api/v1/subscription/subscriptions/{}/billing-schedule",
                    id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(&format!(
                    "/api/v1/subscription/subscriptions/{}/revenue-schedule",
                    id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/subscription/revenue-lines/{}/recognize",
                    first_line_id
                ))
                .header(&k, &v)
                .body(Body::empty())
