...
async fn create_test_template(app: &axum::Router, code: &str) -> serde_json::Value {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/supplier-scorecard/templates")
...
async fn create_test_category(
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/supplier-scorecard/categories")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
...
async fn create_test_scorecard(
    app: &axum::Router,
    template_id: &str,
    num: &str,
) -> serde_json::Value {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/supplier-scorecard/scorecards")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
...
async fn test_delete_template() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("DELETE")
                .uri("/api/v1/supplier-scorecard/templates-by-code/DEL")
                .header(&k, &v)
                .body(Body::empty())
                .unwrap(),
        )
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri(&format!(
                    "/api/v1/supplier-scorecard/templates/{}/categories",
                    template_id
                ))
                .header(&k, &v)
                .body(Body::empty())
...
async fn test_list_scorecards() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri("/api/v1/supplier-scorecard/scorecards?status=draft")
                .header(&k, &v)
                .body(Body::empty())
                .unwrap(),
        )
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/supplier-scorecard/scorecards/{}/lines",
                    sc_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/supplier-scorecard/scorecards/{}/submit",
                    sc_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/supplier-scorecard/scorecards/{}/approve",
                    sc_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/supplier-scorecard/scorecards/{}/reject",
                    sc_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
...
async fn test_create_review() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/supplier-scorecard/reviews")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/supplier-scorecard/reviews/{}/complete",
                    rev_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/supplier-scorecard/reviews/{}/action-items",
                    rev_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
...
async fn test_scorecard_dashboard() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("GET")
                .uri("/api/v1/supplier-scorecard/dashboard")
                .header(&k, &v)
                .body(Body::empty())
                .unwrap(),
        )
