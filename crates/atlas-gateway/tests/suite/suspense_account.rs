...
async fn test_deactivate_and_delete_definition() {
    ...
    let r = app
        ...
        .await
        .unwrap();
    let def: serde_json::Value = serde_json::from_slice(
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/suspense/clearing-batches/{}/lines",
                    batch_id
                ))
                .header("Content-Type", "application/json")
                .header(&k, &v)
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/suspense/clearing-batches/{}/submit",
                    batch_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/suspense/clearing-batches/{}/approve",
                    batch_id
                ))
                .header(&k, &v)
                .body(Body::empty())
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri(&format!(
                    "/api/v1/suspense/clearing-batches/{}/post",
                    batch_id
                ))
                .header(&k, &v)
                .body(Body::empty())
...
async fn test_create_aging_snapshot() {
    ...
    let r = app
        ...
        .oneshot(
            Request::builder()
                .method("POST")
                .uri("/api/v1/suspense/aging-snapshot")
                .header("Content-Type", "application/json")
                .header(&k, &v)
                .body(Body::from(
                    serde_json::to_string(&json!({
