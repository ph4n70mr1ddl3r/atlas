...
CREATE TABLE IF NOT EXISTS _atlas.corporate_card_programs (
    ...
    default_single_purchase_limit TEXT NOT NULL DEFAULT 0,
    default_monthly_limit TEXT NOT NULL DEFAULT 0,
    default_cash_limit TEXT NOT NULL DEFAULT 0,
    default_atm_limit TEXT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS _atlas.corporate_cards (
    ...
    single_purchase_limit TEXT NOT NULL DEFAULT 0,
    monthly_limit TEXT NOT NULL DEFAULT 0,
    cash_limit TEXT NOT NULL DEFAULT 0,
    atm_limit TEXT NOT NULL DEFAULT 0,
    current_balance TEXT NOT NULL DEFAULT 0,
    total_spend_current_cycle TEXT NOT NULL DEFAULT 0,
    last_statement_balance TEXT NOT NULL DEFAULT 0,
