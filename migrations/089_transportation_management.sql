...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_carriers_org ON _atlas.carriers(organization_id);
CREATE INDEX IF NOT EXISTS idx_carriers_status ON _atlas.carriers(status);
CREATE INDEX IF NOT EXISTS idx_carriers_type ON _atlas.carriers(carrier_type);
CREATE INDEX IF NOT EXISTS idx_carrier_services_carrier ON _atlas.carrier_services(carrier_id);
CREATE INDEX IF NOT EXISTS idx_carrier_services_active ON _atlas.carrier_services(is_active);
CREATE INDEX IF NOT EXISTS idx_transport_lanes_org ON _atlas.transport_lanes(organization_id);
CREATE INDEX IF NOT EXISTS idx_transport_lanes_status ON _atlas.transport_lanes(status);
CREATE INDEX IF NOT EXISTS idx_transport_lanes_route ON _atlas.transport_lanes(origin_country, destination_country);
CREATE INDEX IF NOT EXISTS idx_transport_shipments_org ON _atlas.transport_shipments(organization_id);
CREATE INDEX IF NOT EXISTS idx_transport_shipments_status ON _atlas.transport_shipments(status);
CREATE INDEX IF NOT EXISTS idx_transport_shipments_carrier ON _atlas.transport_shipments(carrier_id);
CREATE INDEX IF NOT EXISTS idx_transport_shipments_dates ON _atlas.transport_shipments(planned_ship_date, planned_delivery_date);
CREATE INDEX IF NOT EXISTS idx_transport_shipments_tracking ON _atlas.transport_shipments(tracking_number);
CREATE INDEX IF NOT EXISTS idx_shipment_stops_shipment ON _atlas.shipment_stops(shipment_id);
CREATE INDEX IF NOT EXISTS idx_transport_shipment_lines_shipment ON _atlas.transport_shipment_lines(shipment_id);
CREATE INDEX IF NOT EXISTS idx_tracking_events_shipment ON _atlas.shipment_tracking_events(shipment_id);
CREATE INDEX IF NOT EXISTS idx_tracking_events_timestamp ON _atlas.shipment_tracking_events(event_timestamp);
CREATE INDEX IF NOT EXISTS idx_freight_rates_org ON _atlas.freight_rates(organization_id);
CREATE INDEX IF NOT EXISTS idx_freight_rates_carrier ON _atlas.freight_rates(carrier_id);
CREATE INDEX IF NOT EXISTS idx_freight_rates_status ON _atlas.freight_rates(status);
CREATE INDEX IF NOT EXISTS idx_freight_rates_effective ON _atlas.freight_rates(effective_from, effective_to);
