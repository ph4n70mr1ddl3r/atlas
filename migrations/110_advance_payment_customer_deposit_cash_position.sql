...
CREATE TABLE IF NOT EXISTS _atlas.advance_payments (
...
CREATE TABLE IF NOT EXISTS _atlas.advance_applications (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    organization_id UUID NOT NULL,
    advance_id UUID NOT NULL REFERENCES _atlas.advance_payments(id),
...
CREATE TABLE IF NOT EXISTS _atlas.customer_deposits (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    organization_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS _atlas.deposit_applications (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    organization_id UUID NOT NULL,
    deposit_id UUID NOT NULL REFERENCES _atlas.customer_deposits(id),
